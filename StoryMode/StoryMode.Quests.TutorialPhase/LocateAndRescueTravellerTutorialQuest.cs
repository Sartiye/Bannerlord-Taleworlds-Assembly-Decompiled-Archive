...
public class LocateAndRescueTravellerTutorialQuest : StoryModeQuestBase
{
	...
	private MobileParty CreateRaiderParty()
	{
		...
		CampaignVec2 initialPosition = NavigationHelper.FindReachablePointAroundPosition(@object.GatePosition, MobileParty.NavigationType.Default, MobileParty.MainParty.SeeingRange * 0.75f, 1f);
		...
		mobileParty.MemberRoster.AddToCounts(object2, 6);
