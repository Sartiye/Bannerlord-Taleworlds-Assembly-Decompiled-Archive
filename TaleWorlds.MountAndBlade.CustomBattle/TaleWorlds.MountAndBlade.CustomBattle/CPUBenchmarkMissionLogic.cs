...
public class CPUBenchmarkMissionLogic : MissionLogic
{
	...
	public static Mission OpenCPUBenchmarkMission(string scene)
	{
		...
		CustomBattleCombatant playerParty = new CustomBattleCombatant(new TextObject("{=!}Player Party"), @object, banner);
		CustomBattleCombatant enemyParty = new CustomBattleCombatant(new TextObject("{=!}Enemy Party"), @object, banner2);
		if (!_isSiege)
		{
