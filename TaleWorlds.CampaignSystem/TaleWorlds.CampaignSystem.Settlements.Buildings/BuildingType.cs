	...
	public TextObject GetExplanationAtLevel(int level)
	{
		...
		else if (array.Length >= 2)
		{
			...
			for (int i = 2; i < array.Length; i++)
			{
				...
				textObject5.SetTextVariable("BONUS_AMOUNT", array[i].GetEffectValue(level));
				textObject5.SetTextVariable("BONUS_AMOUNT_PERCENT", array[i].GetEffectValue(level) * 100f);
