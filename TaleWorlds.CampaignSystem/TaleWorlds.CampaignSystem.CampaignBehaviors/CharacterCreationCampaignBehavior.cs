...
public class CharacterCreationCampaignBehavior : CampaignBehaviorBase, ICharacterCreationContentHandler
{
	...
	private List<NarrativeMenuCharacterArgs> GetYouthMenuNarrativeMenuCharacterArgs(CultureObject culture, string occupationType, CharacterCreationManager characterCreationManager)
	{
		...
		list.Add(new NarrativeMenuCharacterArgs(mountCreationKey: MountCreationKey.GetRandomMountKey(@object.DefaultEquipment[EquipmentIndex.ArmorItemEndSlot].Item, CharacterObject.PlayerCharacter.GetMountKeySeed()), characterId: "narrative_character_horse", age: -1, equipmentId: "", animationId: "act_inventory_idle_start", spawnPointEntityId: "spawnpoint_mount_1", leftHandItemId: @object.DefaultEquipment[EquipmentIndex.ArmorItemEndSlot].Item.StringId, rightHandItemId: @object.DefaultEquipment[EquipmentIndex.HorseHarness].Item.StringId, isHuman: false));
		return list;
	}
	...
	private List<NarrativeMenuCharacterArgs> GetAdultMenuNarrativeMenuCharacterArgs(CultureObject culture, string occupationType, CharacterCreationManager characterCreationManager)
	{
		...
		MBEquipmentRoster @object = Game.Current.ObjectManager.GetObject<MBEquipmentRoster>(playerEquipmentId);
		list.Add(new NarrativeMenuCharacterArgs(mountCreationKey: MountCreationKey.GetRandomMountKey(@object.DefaultEquipment[EquipmentIndex.ArmorItemEndSlot].Item, CharacterObject.PlayerCharacter.GetMountKeySeed()), characterId: "narrative_character_horse", age: -1, equipmentId: "", animationId: "act_horse_stand_1", spawnPointEntityId: "spawnpoint_mount_1", leftHandItemId: @object.DefaultEquipment[EquipmentIndex.ArmorItemEndSlot].Item.StringId, rightHandItemId: @object.DefaultEquipment[EquipmentIndex.HorseHarness].Item.StringId, isHuman: false));
		return list;
	}
