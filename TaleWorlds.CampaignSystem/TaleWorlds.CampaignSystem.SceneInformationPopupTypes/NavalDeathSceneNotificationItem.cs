...
public class NavalDeathSceneNotificationItem : SceneNotificationData
{
	...
	public override NotificationSceneProperties SceneProperties
	{
		get
		{
			NotificationSceneProperties result = default(NotificationSceneProperties);
			result.InitializePhysics = true;
			result.DisableStaticShadows = true;
			result.OverriddenWaterStrength = null;
			return result;
		}
	}
