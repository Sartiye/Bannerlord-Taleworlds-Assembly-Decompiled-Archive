...
internal class AIMoveToNearestLandBehavior : CampaignBehaviorBase
{
	...
	private void AiHourlyTick(MobileParty mobileParty, PartyThinkParams p)
	{
		...
		if (num3 > 0.75f)
		{
			...
			(AIBehaviorData, float) value = (new AIBehaviorData(settlement, AiBehavior.MoveToNearestLandOrPort, MobileParty.NavigationType.All, willGatherArmy: false, isFromPort: false, isTargetingPort: false), num4);
