...
public class CampaignObjectManager
{
	...
	public MBReadOnlyList<BattleWreckage> Wreckages => _wreckages;
	...
	{
		_objects = new ICampaignObjectType[6];
		...
		_wreckages = new MBList<BattleWreckage>();
	}
	...
	private void InitializeManagerObjectLists()
	{
		...
		_objects[5] = new CampaignObjectType<BattleWreckage>(_wreckages);
	...
	private void OnLoad(MetaData metaData, ObjectLoadData objectLoadData)
	{
		...
		_lordParties = new MBList<MobileParty>();
		_partiesWithoutPartyComponent = new MBList<MobileParty>();
		if (MBSaveLoad.IsUpdatingGameVersion && MBSaveLoad.LastLoadedGameVersion < ApplicationVersion.FromString("v1.5.0.113738") && _wreckages == null)
		{
			_wreckages = new MBList<BattleWreckage>();
		}
	}
	...
	internal void AddWreckage(BattleWreckage battleWreckage)
	{
		...
		_wreckages.Add(battleWreckage);
		OnItemAdded(CampaignObjects.Wreckage, battleWreckage);
	}

	internal void RemoveWreckage(BattleWreckage battleWreckage)
	{
		_wreckages.Remove(battleWreckage);
		OnItemRemoved(CampaignObjects.Wreckage, battleWreckage);
	}
	...
	protected virtual void AutoGeneratedInstanceCollectObjects(List<object> collectedObjects)
	{
		...
		collectedObjects.Add(_wreckages);
