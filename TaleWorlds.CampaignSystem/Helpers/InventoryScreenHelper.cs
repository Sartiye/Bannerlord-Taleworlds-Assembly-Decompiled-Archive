...
public static class InventoryScreenHelper
{
	...
	public static InventoryState GetActiveInventoryState()
	{
		...
		Debug.FailedAssert("GetActiveInventoryState requested but the active state is not InventoryState!", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Helpers.cs", "GetActiveInventoryState", 8550);
		return null;
	}
