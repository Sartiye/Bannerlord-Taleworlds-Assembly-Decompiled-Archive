...
public static class NavigationHelper
{
	...
	public static CampaignVec2 FindPointInsideArea(Vec2 minBorders, Vec2 maxBorders, CampaignVec2 center, MobileParty.NavigationType navigationCapability, float maxDistance, float minDistance = 0f, bool requirePathFromCenter = false)
	{
		...
		float b4 = TaleWorlds.Library.MathF.Max(b: center.Distance(new Vec2(a, b)), a: TaleWorlds.Library.MathF.Max(c: center.Distance(new Vec2(a2, b)), a: center.Distance(v), b: center.Distance(v2)));
		maxDistance = TaleWorlds.Library.MathF.Min(maxDistance, b4);
		bool flag = false;
		...
		{
			Debug.FailedAssert("Point should not be invalid!", "C:\\BuildAgent\\work\\mb3\\Source\\Bannerlord\\TaleWorlds.CampaignSystem\\Helpers.cs", "FindPointInsideArea", 9803);
