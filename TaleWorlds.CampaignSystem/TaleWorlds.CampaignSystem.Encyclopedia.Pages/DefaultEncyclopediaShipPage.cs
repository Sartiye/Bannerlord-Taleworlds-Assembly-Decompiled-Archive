...
public class DefaultEncyclopediaShipPage : EncyclopediaPage
{
	...
	protected override IEnumerable<EncyclopediaFilterGroup> InitializeFilterItems()
	{
		...
		{
			new EncyclopediaFilterItem(GameTexts.FindText("str_ship_type", "heavy"), (object s) => s is ShipHull shipHull6 && shipHull6.Type == ShipHull.ShipType.Heavy),
			new EncyclopediaFilterItem(GameTexts.FindText("str_ship_type", "medium"), (object s) => s is ShipHull shipHull5 && shipHull5.Type == ShipHull.ShipType.Medium),
			new EncyclopediaFilterItem(GameTexts.FindText("str_ship_type", "light"), (object s) => s is ShipHull shipHull4 && shipHull4.Type == ShipHull.ShipType.Light)
		};
