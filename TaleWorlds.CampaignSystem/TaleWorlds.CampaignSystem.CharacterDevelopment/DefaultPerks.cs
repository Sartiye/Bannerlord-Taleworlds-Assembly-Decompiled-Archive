...
public class DefaultPerks
{
	...
	private void InitializeAll()
	{
		...
		_oneHandedBasher.Initialize("{=6yEeYNRu}Basher", DefaultSkills.OneHanded, GetTierCost(1), _oneHandedWrappedHandles, "{=fFNNeqxu}{VALUE}% damage and longer stun duration with shield bashes.", PartyRole.Personal, 0.5f, EffectIncrementType.AddFactor, "{=goOE8oiI}{VALUE}% damage taken by infantry while in shield wall formation.", PartyRole.Captain, -0.04f, EffectIncrementType.AddFactor, TroopUsageFlags.ShieldUser, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_oneHandedToBeBlunt.Initialize("{=SJ69EYuI}To Be Blunt", DefaultSkills.OneHanded, GetTierCost(2), _oneHandedSwiftStrike, "{=mzUa3duw}{VALUE}% damage with one handed axes and maces.", PartyRole.Personal, 0.05f, EffectIncrementType.AddFactor, "{=Ib9RYpMO}{VALUE} daily security to governed settlement.", PartyRole.Governor, 0.5f, EffectIncrementType.Add, TroopUsageFlags.OneHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_oneHandedSwiftStrike.Initialize("{=ciELES5v}Swift Strike", DefaultSkills.OneHanded, GetTierCost(2), _oneHandedToBeBlunt, "{=bW7DT97A}{VALUE}% swing speed with one handed weapons.", PartyRole.Personal, 0.02f, EffectIncrementType.AddFactor, "{=xwA6Om0Y}{VALUE} daily militia recruitment in the governed settlement.", PartyRole.Governor, 1f, EffectIncrementType.Add, TroopUsageFlags.OneHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_oneHandedShieldBearer.Initialize("{=vnG1q18y}Shield Bearer", DefaultSkills.OneHanded, GetTierCost(3), _oneHandedCavalry, "{=hMJVRJdw}Removed movement speed penalty of wielding shields.", PartyRole.Personal, 0f, EffectIncrementType.Invalid, "{=1QsZq9UW}{VALUE}% movement speed to infantry in your formation.", PartyRole.Captain, 0.03f, EffectIncrementType.AddFactor, TroopUsageFlags.OnFoot | TroopUsageFlags.ShieldUser, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_oneHandedTrainer.Initialize("{=UE2X5rAy}Trainer", DefaultSkills.OneHanded, GetTierCost(4), _oneHandedDuelist, "{=Ti9auMiO}{VALUE} hit points.", PartyRole.Personal, 2f, EffectIncrementType.Add, "{=rXb91Rwi}{VALUE}% experience to melee troops in your party after every battle.", PartyRole.PartyLeader, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Any, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.All, PerkObject.EffectEnvironment.NavalReduced);
		_oneHandedDuelist.Initialize("{=XphY9cNV}Duelist", DefaultSkills.OneHanded, GetTierCost(4), _oneHandedTrainer, "{=uRZgz63l}{VALUE}% damage while wielding a one handed weapon without a shield.", PartyRole.Personal, 0.2f, EffectIncrementType.AddFactor, "{=uKTgBX4S}Double the amount of renown gained from tournaments.", PartyRole.Personal, 2f, EffectIncrementType.AddFactor, TroopUsageFlags.OneHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_oneHandedMilitaryTradition.Initialize("{=Fc7OsyZ8}Military Tradition", DefaultSkills.OneHanded, GetTierCost(6), _oneHandedCorpsACorps, "{=0A6BUASZ}{VALUE} daily experience to infantry in your party.", PartyRole.PartyLeader, 2f, EffectIncrementType.Add, "{=B2msxAju}{VALUE}% garrison wages in the governed settlement.", PartyRole.Governor, -0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		_oneHandedCorpsACorps.Initialize("{=M3aNEkBJ}Corps-a-corps", DefaultSkills.OneHanded, GetTierCost(6), _oneHandedMilitaryTradition, "{=8jHJeh8z}{VALUE}% of the total experience gained as a bonus to infantry after battles.", PartyRole.PartyLeader, 0.1f, EffectIncrementType.AddFactor, "{=wBgpln4f}{VALUE} garrison limit in the governed settlement.", PartyRole.Governor, 30f, EffectIncrementType.Add, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_oneHandedStandUnited.Initialize("{=d8qjwKza}Stand United", DefaultSkills.OneHanded, GetTierCost(7), _oneHandedLeadByExample, "{=JZ8ihtoa}{VALUE} starting battle morale to troops in your party if you are outnumbered.", PartyRole.PartyLeader, 8f, EffectIncrementType.Add, "{=5aVPqukr}{VALUE}% security provided by troops in the garrison of the governed settlement.", PartyRole.Governor, 0.3f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_oneHandedFleetOfFoot.Initialize("{=OtdkOGur}Fleet of Foot", DefaultSkills.OneHanded, GetTierCost(8), _oneHandedSteelCoreShields, "{=V53EYEXx}{VALUE}% combat movement speed.", PartyRole.Personal, 0.04f, EffectIncrementType.AddFactor, "{=1QsZq9UW}{VALUE}% movement speed to infantry in your formation.", PartyRole.Captain, 0.04f, EffectIncrementType.AddFactor, TroopUsageFlags.Any, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_oneHandedPrestige.Initialize("{=DSKtsYPi}Prestige", DefaultSkills.OneHanded, GetTierCost(10), _oneHandedChinkInTheArmor, "{=LjeYTgX7}{VALUE}% damage against shields with one handed weapons.", PartyRole.Personal, 0.5f, EffectIncrementType.AddFactor, "{=qxbBsB1a}{VALUE} party limit.", PartyRole.PartyLeader, 15f, EffectIncrementType.Add, TroopUsageFlags.OneHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_oneHandedChinkInTheArmor.Initialize("{=bBa0LB1D}Chink in the Armor", DefaultSkills.OneHanded, GetTierCost(10), _oneHandedPrestige, "{=KKsCor3D}{VALUE}% armor penetration with melee attacks.", PartyRole.Personal, 0.1f, EffectIncrementType.AddFactor, "{=3a6tmImq}{VALUE}% recruitment cost of infantry.", PartyRole.PartyLeader, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.Melee, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_twoHandedOnTheEdge.Initialize("{=rkuAgPSA}On the Edge", DefaultSkills.TwoHanded, GetTierCost(2), _twoHandedHeadBasher, "{=R8Lnif8l}{VALUE}% swing speed with two handed weapons.", PartyRole.Personal, 0.03f, EffectIncrementType.AddFactor, "{=Tq0E9sSW}{VALUE}% swing speed to infantry in your formation.", PartyRole.Captain, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.TwoHandedUser, TroopUsageFlags.OnFoot | TroopUsageFlags.Melee, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_twoHandedShowOfStrength.Initialize("{=RlMqzqbS}Show of Strength", DefaultSkills.TwoHanded, GetTierCost(3), _twoHandedBaptisedInBlood, "{=eaUjIK1D}Two handed weapons that can knockdown ignore {VALUE}% knockdown resistance on swing attacks.", PartyRole.Personal, 0.3f, EffectIncrementType.Add, "{=3a6tmImq}{VALUE}% recruitment cost of infantry.", PartyRole.PartyLeader, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.TwoHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_twoHandedBerserker.Initialize("{=RssJTUpL}Berserker", DefaultSkills.TwoHanded, GetTierCost(5), _twoHandedConfidence, "{=D5RqqHIm}{VALUE}% damage with two handed weapons while you have less than half of your hit points.", PartyRole.Personal, 0.2f, EffectIncrementType.AddFactor, "{=B2msxAju}{VALUE}% garrison wages in the governed settlement.", PartyRole.Governor, -0.1f, EffectIncrementType.AddFactor, TroopUsageFlags.TwoHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_twoHandedConfidence.Initialize("{=2jnsxsv5}Confidence", DefaultSkills.TwoHanded, GetTierCost(5), _twoHandedBerserker, "{=QUXbhsxb}{VALUE}% damage with two handed weapons while you have more than 90% of your hit points.", PartyRole.Personal, 0.15f, EffectIncrementType.AddFactor, "{=FX0GjiNa}{VALUE}% build speed to military projects in the governed settlement.", PartyRole.Governor, 0.3f, EffectIncrementType.AddFactor, TroopUsageFlags.TwoHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_twoHandedProjectileDeflection.Initialize("{=rCCG4mSJ}Projectile Deflection", DefaultSkills.TwoHanded, GetTierCost(6), null, "{=YP8tN7nl}You can deflect projectiles with two handed swords by blocking.", PartyRole.Personal, 0f, EffectIncrementType.Invalid, "{=FdSPC05Q}{VALUE}% experience to garrison troops in the governed settlement.", PartyRole.Governor, 0.1f, EffectIncrementType.AddFactor, TroopUsageFlags.TwoHandedUser);
		_twoHandedTerror.Initialize("{=nAlCj2m0}Terror", DefaultSkills.TwoHanded, GetTierCost(7), _twoHandedHope, "{=thGHcZMB}{VALUE}% battle morale effect to enemy troops with your two handed kills.", PartyRole.Personal, 0.2f, EffectIncrementType.AddFactor, "{=POp8DAZD}{VALUE} prisoner limit.", PartyRole.PartyLeader, 10f, EffectIncrementType.Add, TroopUsageFlags.TwoHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_twoHandedHope.Initialize("{=lPuk6bao}Hope", DefaultSkills.TwoHanded, GetTierCost(7), _twoHandedTerror, "{=2zNrVsDj}{VALUE}% battle morale effect to friendly troops with your two handed kills.", PartyRole.Personal, 0.3f, EffectIncrementType.AddFactor, "{=qxbBsB1a}{VALUE} party limit.", PartyRole.PartyLeader, 5f, EffectIncrementType.Add, TroopUsageFlags.TwoHandedUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_twoHandedThickHides.Initialize("{=j9OIuxxY}Thick Hides", DefaultSkills.TwoHanded, GetTierCost(8), _twoHandedRecklessCharge, "{=Ti9auMiO}{VALUE} hit points.", PartyRole.Personal, 5f, EffectIncrementType.Add, "{=ucHrYWaz}{VALUE} hit points to troops in your party.", PartyRole.PartyLeader, 5f, EffectIncrementType.Add, TroopUsageFlags.Any, TroopUsageFlags.Any, PerkObject.EffectEnvironment.All, PerkObject.EffectEnvironment.LandOnly);
		...
		_polearmPikeman.Initialize("{=IFqtwpb0}Pikeman", DefaultSkills.Polearm, GetTierCost(1), _polearmCavalry, "{=NtzmIh0g}{VALUE}% damage with polearms on foot.", PartyRole.Personal, 0.02f, EffectIncrementType.AddFactor, "{=Yu5hTuIN}{VALUE}% damage by infantry troops in your formation.", PartyRole.Captain, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.OnFoot | TroopUsageFlags.PolearmUser, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_polearmBraced.Initialize("{=dU7haWkI}Braced", DefaultSkills.Polearm, GetTierCost(2), _polearmKeepAtBay, "{=QFaoD1Ka}Polearms that can dismount ignore {VALUE}% dismount resistance on attacks against cavalry.", PartyRole.Personal, 0.25f, EffectIncrementType.Add, "{=OWXECmbt}{VALUE}% damage by infantry in your formation against cavalry.", PartyRole.Captain, 0.1f, EffectIncrementType.AddFactor, TroopUsageFlags.PolearmUser, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.All, PerkObject.EffectEnvironment.LandOnly);
		_polearmKeepAtBay.Initialize("{=TaucWWCB}Keep at Bay", DefaultSkills.Polearm, GetTierCost(2), _polearmBraced, "{=iqRCAb6f}Polearms ignore {VALUE}% knockback resistance on thrust attacks against footmen.", PartyRole.Personal, 0.3f, EffectIncrementType.Add, "{=g9gTYB8u}{VALUE} militia recruitment in the governed settlement.", PartyRole.Governor, 1f, EffectIncrementType.Add, TroopUsageFlags.PolearmUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_polearmSwiftSwing.Initialize("{=xM5aawCj}Swift Swing", DefaultSkills.Polearm, GetTierCost(3), _polearmCleanThrust, "{=7tdcIxYN}{VALUE}% swing speed with polearms.", PartyRole.Personal, 0.05f, EffectIncrementType.AddFactor, "{=Tq0E9sSW}{VALUE}% swing speed to infantry in your formation.", PartyRole.Captain, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.PolearmUser, TroopUsageFlags.OnFoot | TroopUsageFlags.Melee, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_polearmFootwork.Initialize("{=Yvk8a2tb}Footwork", DefaultSkills.Polearm, GetTierCost(4), _polearmHardKnock, "{=eDzl7r8u}{VALUE}% combat movement speed with polearms.", PartyRole.Personal, 0.02f, EffectIncrementType.AddFactor, "{=1QsZq9UW}{VALUE}% movement speed to infantry in your formation.", PartyRole.Captain, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.OnFoot | TroopUsageFlags.PolearmUser, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_polearmHardKnock.Initialize("{=8DTKXbKw}Hard Knock", DefaultSkills.Polearm, GetTierCost(4), _polearmFootwork, "{=h0HC4a7q}Polearms that can knockdown ignore {VALUE}% knockdown resistance on thrust attacks.", PartyRole.Personal, 0.25f, EffectIncrementType.Add, "{=aeNhsyD7}{VALUE} hit points to infantry in your party.", PartyRole.PartyLeader, 3f, EffectIncrementType.Add, TroopUsageFlags.PolearmUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_polearmStandardBearer.Initialize("{=Vv81gkWN}Standard Bearer", DefaultSkills.Polearm, GetTierCost(7), _polearmPhalanx, "{=RbDAfDsF}{VALUE}% battle morale loss to troops in your formation.", PartyRole.Captain, -0.2f, EffectIncrementType.AddFactor, "{=V2v4ZMDT}{VALUE}% wages to garrisoned infantry in the governed settlement.", PartyRole.Governor, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.Any, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_polearmPhalanx.Initialize("{=5vs3qlQ8}Phalanx", DefaultSkills.Polearm, GetTierCost(7), _polearmStandardBearer, "{=3zzWzQcO}{VALUE} melee weapon skills to troops in your party while in shield wall formation.", PartyRole.PartyLeader, 30f, EffectIncrementType.Add, "{=yank0KD9}{VALUE}% damage with polearms by troops in your formation.", PartyRole.Captain, 0.03f, EffectIncrementType.AddFactor, TroopUsageFlags.PolearmUser, TroopUsageFlags.PolearmUser, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		_polearmHardyFrontline.Initialize("{=NtMEk0lA}Hardy Frontline", DefaultSkills.Polearm, GetTierCost(8), _polearmDrills, "{=ucHrYWaz}{VALUE} hit points to troops in your party.", PartyRole.PartyLeader, 5f, EffectIncrementType.Add, "{=3a6tmImq}{VALUE}% recruitment cost of infantry.", PartyRole.PartyLeader, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.Any, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_polearmSharpenTheTip.Initialize("{=ljduhdzj}Sharpen the Tip", DefaultSkills.Polearm, GetTierCost(10), _polearmCounterweight, "{=sbkrplXi}{VALUE}% damage with thrust attacks made with polearms.", PartyRole.Personal, 0.05f, EffectIncrementType.AddFactor, "{=wLrF0mzr}{VALUE}% damage with thrust attacks by infantry troops in your formation.", PartyRole.Captain, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.PolearmUser, TroopUsageFlags.OnFoot | TroopUsageFlags.Melee, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_bowBowControl.Initialize("{=1zteHA7R}Bow Control", DefaultSkills.Bow, GetTierCost(1), _bowDeadAim, "{=4PdKPMNc}{VALUE}% accuracy penalty while moving.", PartyRole.Personal, -0.3f, EffectIncrementType.AddFactor, "{=0DaxFvnw}{VALUE}% damage with bows by troops in your formation.", PartyRole.Captain, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Ranged, TroopUsageFlags.BowUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_bowNockingPoint.Initialize("{=bS8alS24}Nocking Point", DefaultSkills.Bow, GetTierCost(2), _bowBodkin, "{=zady0hI7}{VALUE}% movement speed penalty while reloading.", PartyRole.Personal, -0.5f, EffectIncrementType.AddFactor, "{=kaJ6SJeI}{VALUE}% movement speed to archers in your formation.", PartyRole.Captain, 0.03f, EffectIncrementType.AddFactor, TroopUsageFlags.Ranged, TroopUsageFlags.BowUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_bowStrongBows.Initialize("{=dqbbT5DK}Strong bows", DefaultSkills.Bow, GetTierCost(5), _bowTrainer, "{=FXWn934b}{VALUE}% damage with bows.", PartyRole.Personal, 0.08f, EffectIncrementType.AddFactor, "{=yppPCR1z}{VALUE}% damage with bows by tier 3+ troops in your formation.", PartyRole.Captain, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.BowUser, TroopUsageFlags.BowUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_bowDiscipline.Initialize("{=D867vF71}Discipline", DefaultSkills.Bow, GetTierCost(6), _bowHunterClan, "{=sHiIwnOb}{VALUE}% aiming duration without losing accuracy.", PartyRole.Personal, 0.5f, EffectIncrementType.AddFactor, "{=F7bbkYx4}{VALUE} loyalty per day in the governed settlement.", PartyRole.Governor, 1f, EffectIncrementType.Add, TroopUsageFlags.Ranged, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_bowDeepQuivers.Initialize("{=h83ZU95t}Deep Quivers", DefaultSkills.Bow, GetTierCost(9), _bowHorseMaster, "{=YOQQR1bJ}{VALUE} extra arrows per quiver.", PartyRole.Personal, 3f, EffectIncrementType.Add, "{=CBVfPRRe}{VALUE} extra arrow per quiver to troops in your party.", PartyRole.PartyLeader, 1f, EffectIncrementType.Add, TroopUsageFlags.BowUser, TroopUsageFlags.BowUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_bowQuickDraw.Initialize("{=vnJndBgT}Quick Draw", DefaultSkills.Bow, GetTierCost(10), _bowRangersSwiftness, "{=jU084S5S}{VALUE}% aiming speed with bows.", PartyRole.Personal, 0.25f, EffectIncrementType.AddFactor, "{=tsh4RXNa}{VALUE}% tax gain in the governed settlement.", PartyRole.Governor, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.BowUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_bowRangersSwiftness.Initialize("{=p12tSfCC}Ranger's Swiftness", DefaultSkills.Bow, GetTierCost(10), _bowQuickDraw, "{=RQd005zy}Equipped bows do not slow you down.", PartyRole.Personal, 0f, EffectIncrementType.Invalid, "{=6XDcZUsb}{VALUE}% security provided by archers in the governed settlement.", PartyRole.Governor, 0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.BowUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_crossbowPiercer.Initialize("{=v8RwzwqD}Piercer", DefaultSkills.Crossbow, GetTierCost(1), _crossbowMarksmen, "{=j3J0Hbax}Your crossbow attacks ignore armors below 20.", PartyRole.Personal, 20f, EffectIncrementType.Add, "{=CLBXxPdh}{VALUE}% recruitment cost of ranged troops.", PartyRole.PartyLeader, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.CrossbowUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_crossbowWindWinder.Initialize("{=1bw2uw8H}Wind Winder", DefaultSkills.Crossbow, GetTierCost(2), _crossbowUnhorser, "{=3cBX5x0x}{VALUE}% reload speed with crossbows.", PartyRole.Personal, 0.25f, EffectIncrementType.AddFactor, "{=YHjdf1uO}{VALUE}% crossbow reload speed to troops in your formation.", PartyRole.Captain, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.CrossbowUser, TroopUsageFlags.CrossbowUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_crossbowDonkeysSwiftness.Initialize("{=uANbQUxg}Donkey's Swiftness", DefaultSkills.Crossbow, GetTierCost(3), _crossbowSheriff, "{=Af7zOV2l}{VALUE}% accuracy loss while moving.", PartyRole.Personal, -0.3f, EffectIncrementType.AddFactor, "{=aIyRxlCf}{VALUE} crossbow skill to troops in your formation.", PartyRole.Captain, 30f, EffectIncrementType.Add, TroopUsageFlags.Ranged, TroopUsageFlags.CrossbowUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_crossbowPeasantLeader.Initialize("{=2rPMYl7Y}Peasant Leader", DefaultSkills.Crossbow, GetTierCost(4), _crossbowRenownMarksmen, "{=4CSaYB8H}{VALUE}% battle morale to tier 1 to 3 troops", PartyRole.PartyLeader, 0.1f, EffectIncrementType.AddFactor, "{=xuUbaa9f}{VALUE}% garrisoned ranged troop wages in the governed settlement.", PartyRole.Governor, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_crossbowRenownMarksmen.Initialize("{=ICkvftaM}Renowned Marksmen", DefaultSkills.Crossbow, GetTierCost(4), _crossbowPeasantLeader, "{=uj52xbdr}{VALUE} daily experience to ranged troops in your party.", PartyRole.PartyLeader, 2f, EffectIncrementType.Add, "{=i4GboakR}{VALUE}% security provided by ranged troops in the garrison of the governed settlement.", PartyRole.Governor, 0.3f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		_crossbowFletcher.Initialize("{=FA5QlTvm}Fletcher", DefaultSkills.Crossbow, GetTierCost(5), _crossbowPuncture, "{=wvQbeHpp}{VALUE} bolts per quiver.", PartyRole.Personal, 4f, EffectIncrementType.Add, "{=j3Hcp9RQ}{VALUE} bolts per quiver to troops in your party.", PartyRole.PartyLeader, 2f, EffectIncrementType.Add, TroopUsageFlags.CrossbowUser, TroopUsageFlags.CrossbowUser, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		...
		_crossbowDeftHands.Initialize("{=NYHeygaj}Deft Hands", DefaultSkills.Crossbow, GetTierCost(6), _crossbowLooseAndMove, "{=VY7WQSgu}{VALUE}% resistance to getting staggered while reloading your crossbow.", PartyRole.Personal, 0.5f, EffectIncrementType.AddFactor, "{=wUov3khT}{VALUE}% resistance to getting staggered while reloading crossbows to troops in your formation.", PartyRole.Captain, 0.5f, EffectIncrementType.AddFactor, TroopUsageFlags.CrossbowUser, TroopUsageFlags.CrossbowUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_crossbowLongShots.Initialize("{=Y5KXWHJY}Long Shots", DefaultSkills.Crossbow, GetTierCost(8), _crossbowSteady, "{=Stykk4VR}{VALUE}% more zoom with crossbows.", PartyRole.Personal, 1f, EffectIncrementType.AddFactor, "{=xwA6Om0Y}{VALUE} daily militia recruitment in the governed settlement.", PartyRole.Governor, 1f, EffectIncrementType.Add, TroopUsageFlags.CrossbowUser, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_crossbowHammerBolts.Initialize("{=FjMS9Mbz}Hammer Bolts", DefaultSkills.Crossbow, GetTierCost(9), _crossbowPavise, "{=Y9Af8mOd}Crossbows can now dismount and ignore {VALUE}% dismount resistance on attacks against cavalry.", PartyRole.Personal, 0.5f, EffectIncrementType.Add, "{=yz8xogMc}{VALUE}% damage with crossbows by troops in your formation.", PartyRole.Captain, 0.1f, EffectIncrementType.AddFactor, TroopUsageFlags.CrossbowUser, TroopUsageFlags.CrossbowUser, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		_crossbowPavise.Initialize("{=2667CwaK}Pavise", DefaultSkills.Crossbow, GetTierCost(9), _crossbowHammerBolts, "{=pr5vaFNc}{VALUE}% chance of blocking projectiles from behind with a shield on your back.", PartyRole.Personal, 0.75f, EffectIncrementType.AddFactor, "{=Q8LSfvIO}{VALUE}% accuracy to ballistas in the governed settlement.", PartyRole.Governor, 0.3f, EffectIncrementType.AddFactor, TroopUsageFlags.Any, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_crossbowTerror.Initialize("{=nAlCj2m0}Terror", DefaultSkills.Crossbow, GetTierCost(10), _crossbowPickedShots, "{=NGFbn4Qx}{VALUE}% chance of increasing the siege bombardment casualties per hit by 1.", PartyRole.PartyLeader, 0.2f, EffectIncrementType.AddFactor, "{=sUFw8cDt}{VALUE}% morale loss to enemy due to crossbow kills by troops in your formation.", PartyRole.Captain, 0.25f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.CrossbowUser, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		...
		_throwingRunningThrow.Initialize("{=OcaW12fJ}Running Throw", DefaultSkills.Throwing, GetTierCost(4), _throwingKnockOff, "{=Z4maWcyl}{VALUE}% damage bonus from speed with throwing weapons.", PartyRole.Personal, 0.25f, EffectIncrementType.Add, "{=a5CWbHsd}{VALUE} throwing skill to troops in your formation.", PartyRole.Captain, 30f, EffectIncrementType.Add, TroopUsageFlags.ThrownUser, TroopUsageFlags.ThrownUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_throwingKnockOff.Initialize("{=Gn3KBN8L}Knock Off", DefaultSkills.Throwing, GetTierCost(4), _throwingRunningThrow, "{=WXNOEqwe}Thrown weapons can now dismount and ignore {VALUE}% dismount resistance on attacks against cavalry.", PartyRole.Personal, 0.25f, EffectIncrementType.Add, "{=cJEbenVQ}{VALUE}% throwing weapon damage to cavalry by troops in your formation.", PartyRole.Captain, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.ThrownUser, TroopUsageFlags.Mounted | TroopUsageFlags.ThrownUser, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		...
		_ridingSweepingWind.Initialize("{=gL7Ltjpc}Sweeping Wind", DefaultSkills.Riding, GetTierCost(4), _ridingSagittarius, "{=lTafHBwZ}{VALUE}% top speed to your mount.", PartyRole.Personal, 0.05f, EffectIncrementType.AddFactor, "{=Q74nUiFJ}{VALUE}% party speed.", PartyRole.PartyLeader, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.Mounted, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		_ridingReliefForce.Initialize("{=g5I4qyjw}Relief Force", DefaultSkills.Riding, GetTierCost(5), null, "{=tx37EgiO}{VALUE} starting battle morale when you join an ongoing battle of your allies.", PartyRole.PartyLeader, 10f, EffectIncrementType.Add, "{=RVNPXS46}{VALUE}% security provided by mounted troops in the governed settlement.", PartyRole.Governor, 0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_ridingMountedWarrior.Initialize("{=ixqTFMVA}Mounted Warrior", DefaultSkills.Riding, GetTierCost(6), _ridingHorseArcher, "{=1GwI0hcG}{VALUE}% mounted melee damage.", PartyRole.Personal, 0.05f, EffectIncrementType.AddFactor, "{=f6sgEuS0}{VALUE}% mounted melee damage by troops in your formation.", PartyRole.Captain, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Mounted | TroopUsageFlags.Melee, TroopUsageFlags.Mounted | TroopUsageFlags.Melee, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		...
		_ridingBreeder.Initialize("{=4Pbfs4rV}Breeder", DefaultSkills.Riding, GetTierCost(7), _ridingShepherd, "{=Cpaw42pv}{VALUE}% daily chance of animals in your party reproducing.", PartyRole.PartyLeader, 0.01f, EffectIncrementType.AddFactor, "{=665JbYIC}{VALUE}% production rate to villages bound to the governed settlement.", PartyRole.Governor, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_ridingMountedPatrols.Initialize("{=1z3oRPQu}Mounted Patrols", DefaultSkills.Riding, GetTierCost(9), _ridingCavalryTactics, "{=pAkHwm3k}{VALUE}% escape chance to prisoners in your party.", PartyRole.PartyLeader, -0.5f, EffectIncrementType.AddFactor, "{=mNbAR4uk}{VALUE}% escape chance to prisoners in the governed settlement.", PartyRole.Governor, -0.5f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_ridingTheWayOfTheSaddle.Initialize("{=HvYgMtXO}The Way Of The Saddle", DefaultSkills.Riding, GetTierCost(11), null, "{=nXZktHa6}{VALUE} charge damage and maneuvering for every skill point above 250.", PartyRole.Personal, 0.3f, EffectIncrementType.Add, "", PartyRole.None, 0f, EffectIncrementType.Invalid, TroopUsageFlags.Mounted, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		_athleticsMorningExercise.Initialize("{=ipwU1JT3}Morning Exercise", DefaultSkills.Athletics, GetTierCost(1), _athleticsWellBuilt, "{=V53EYEXx}{VALUE}% combat movement speed.", PartyRole.Personal, 0.03f, EffectIncrementType.AddFactor, "{=nRvR1Rpc}{VALUE}% combat movement speed to troops in your formation.", PartyRole.Captain, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.OnFoot, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_athleticsWellBuilt.Initialize("{=bigS7KHi}Well Built", DefaultSkills.Athletics, GetTierCost(1), _athleticsMorningExercise, "{=Ti9auMiO}{VALUE} hit points.", PartyRole.Personal, 5f, EffectIncrementType.Add, "{=V4zyUiai}{VALUE} hit points to foot troops in your party.", PartyRole.PartyLeader, 5f, EffectIncrementType.Add, TroopUsageFlags.Any, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.All, PerkObject.EffectEnvironment.LandOnly);
		_athleticsFury.Initialize("{=furyPerk}Fury", DefaultSkills.Athletics, GetTierCost(2), _athleticsFormFittingArmor, "{=Epwmv89M}{VALUE}% weapon handling while on foot.", PartyRole.Personal, 0.1f, EffectIncrementType.AddFactor, "{=LGFsDic7}{VALUE}% weapon handling to foot troops in your formation.", PartyRole.Captain, 0.1f, EffectIncrementType.AddFactor, TroopUsageFlags.OnFoot, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_athleticsSprint.Initialize("{=864bKdc6}Sprint", DefaultSkills.Athletics, GetTierCost(4), _athleticsPowerful, "{=mWezTaa1}{VALUE}% combat movement speed when you have no shields and no ranged weapons equipped.", PartyRole.Personal, 0.05f, EffectIncrementType.AddFactor, "{=zoNKoZDZ}{VALUE}% combat movement speed to infantry troops in your formation.", PartyRole.Captain, 0.03f, EffectIncrementType.AddFactor, TroopUsageFlags.OnFoot, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_athleticsPowerful.Initialize("{=UCpyo9hw}Powerful", DefaultSkills.Athletics, GetTierCost(4), _athleticsSprint, "{=CglYgfiY}{VALUE}% damage with melee weapons.", PartyRole.Personal, 0.04f, EffectIncrementType.AddFactor, "{=eBmaa49a}{VALUE}% melee damage by troops in your formation.", PartyRole.Captain, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.Melee, TroopUsageFlags.Melee, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_athleticsSurgingBlow.Initialize("{=zrYFYDfj}Surging Blow", DefaultSkills.Athletics, GetTierCost(5), _athleticsBraced, "{=QiZfTNWJ}{VALUE}% damage bonus from speed while on foot.", PartyRole.Personal, 0.3f, EffectIncrementType.AddFactor, "{=m6RcG1bD}{VALUE}% damage bonus from speed to troops in your formation.", PartyRole.Captain, 0.3f, EffectIncrementType.AddFactor, TroopUsageFlags.OnFoot, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_athleticsStrong.Initialize("{=d5aK6Sv0}Strong", DefaultSkills.Athletics, GetTierCost(8), _athleticsSteady, "{=gtlygHIk}{VALUE} Vigor attribute.", PartyRole.Personal, 1f, EffectIncrementType.Add, "{=yXaozMwY}{VALUE}% party speed by foot troops in your party.", PartyRole.PartyLeader, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.All, PerkObject.EffectEnvironment.LandOnly);
		_athleticsStrongLegs.Initialize("{=guZWnzaV}Strong Legs", DefaultSkills.Athletics, GetTierCost(9), _athleticsStrongArms, "{=QIDr1cTd}{VALUE}% fall damage taken and +100% kick damage dealt.", PartyRole.Personal, -0.5f, EffectIncrementType.AddFactor, "{=O3sh2iws}{VALUE}% food consumption in the governed settlement while under siege.", PartyRole.Governor, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.Any, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_athleticsStrongArms.Initialize("{=qBKmIyYx}Strong Arms", DefaultSkills.Athletics, GetTierCost(9), _athleticsStrongLegs, "{=Ztezot02}{VALUE}% damage with throwing weapons.", PartyRole.Personal, 0.05f, EffectIncrementType.AddFactor, "{=a5CWbHsd}{VALUE} throwing skill to troops in your formation.", PartyRole.Captain, 20f, EffectIncrementType.Add, TroopUsageFlags.ThrownUser, TroopUsageFlags.ThrownUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		_athleticsSpartan.Initialize("{=PX0Xufmr}Spartan", DefaultSkills.Athletics, GetTierCost(10), _athleticsIgnorePain, "{=NmGcIg3j}{VALUE}% resistance to getting staggered while on foot.", PartyRole.Personal, 0.5f, EffectIncrementType.AddFactor, "{=6NHvsrrx}{VALUE}% food consumption in your party.", PartyRole.PartyLeader, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.OnFoot, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.NavalReduced);
		...
		_craftingSharpenedEdge.Initialize("{=knWgaYdk}Sharpened Edge", DefaultSkills.Crafting, GetTierCost(10), _craftingSharpenedTip, "{=S7BMf2Wa}{VALUE}% swing damage of crafted weapons.", PartyRole.Personal, 0.02f, EffectIncrementType.AddFactor, "", PartyRole.None, 0f, EffectIncrementType.Invalid, TroopUsageFlags.Melee, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_craftingSharpenedTip.Initialize("{=aO2JSbSq}Sharpened Tip", DefaultSkills.Crafting, GetTierCost(10), _craftingSharpenedEdge, "{=KabSHyf0}{VALUE}% thrust damage of crafted weapons.", PartyRole.Personal, 0.02f, EffectIncrementType.AddFactor, "", PartyRole.None, 0f, EffectIncrementType.Invalid, TroopUsageFlags.Melee, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_scoutingNightRunner.Initialize("{=B8Gq2ylh}Night Runner", DefaultSkills.Scouting, GetTierCost(1), _scoutingDayTraveler, "{=QmaIRD7P}{VALUE}% travel speed during nighttime", PartyRole.Scout, 0.05f, EffectIncrementType.AddFactor, "{=6CteaPKm}{VALUE}% sight range during nighttime in campaign map.", PartyRole.Scout, 0.3f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		_scoutingPathfinder.Initialize("{=d2qGHXyx}Pathfinder", DefaultSkills.Scouting, GetTierCost(2), _scoutingWaterDiviner, "{=ETiOGIvT}{VALUE}% travel speed on steppes and plains.", PartyRole.Scout, 0.02f, EffectIncrementType.AddFactor, "{=sAv1co78}{VALUE}% daily chance to increase relation with a notable by 1 when you enter a town.", PartyRole.PartyLeader, 0.5f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		...
		_scoutingTracker.Initialize("{=AoaabumE}Tracker", DefaultSkills.Scouting, GetTierCost(5), _scoutingRanger, "{=mTHliJuT}{VALUE}% track visibility duration.", PartyRole.Scout, 0.2f, EffectIncrementType.AddFactor, "{=pnAq0a40}{VALUE}% travel speed while following a hostile party.", PartyRole.Scout, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		_scoutingRanger.Initialize("{=09gOOa0h}Ranger", DefaultSkills.Scouting, GetTierCost(5), _scoutingTracker, "{=boXP9vkF}{VALUE}% track spotting distance.", PartyRole.Scout, 0.2f, EffectIncrementType.AddFactor, "{=aeK3ykbL}{VALUE}% track detection chance.", PartyRole.Scout, 0.1f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly, PerkObject.EffectEnvironment.LandOnly);
		...
		_scoutingVantagePoint.Initialize("{=EC2n5DBl}Vantage Point", DefaultSkills.Scouting, GetTierCost(9), _scoutingKeenSight, "{=Y1lC59hw}{VALUE}% sight range when stationary for at least an hour.", PartyRole.Scout, 0.25f, EffectIncrementType.AddFactor, "{=POp8DAZD}{VALUE} prisoner limit.", PartyRole.PartyLeader, 10f, EffectIncrementType.Add, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_scoutingUncannyInsight.Initialize("{=M9vC9mio}Uncanny Insight", DefaultSkills.Scouting, GetTierCost(11), null, "{=4Onw6Gxa}{VALUE}% party speed for every skill point above 200 scouting skill.", PartyRole.Scout, 0.001f, EffectIncrementType.AddFactor, "", PartyRole.None, 0f, EffectIncrementType.Invalid, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_tacticsPreBattleManeuvers.Initialize("{=cHgLxbbc}Pre Battle Maneuvers", DefaultSkills.Tactics, GetTierCost(9), _tacticsBesieged, "{=dPo5goLo}{VALUE}% influence gain from winning battles.", PartyRole.PartyMember, 0.25f, EffectIncrementType.AddFactor, "{=70PZ5mFx}{VALUE}% damage per 100 skill difference with the enemy when troops are sent to confront the enemy.", PartyRole.PartyLeader, 0.01f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.All, PerkObject.EffectEnvironment.LandOnly);
		...
		_tacticsTacticalMastery.Initialize("{=8rvpcb4k}Tactical Mastery", DefaultSkills.Tactics, GetTierCost(11), null, "{=ClrLzkvx}{VALUE}% damage for every skill point above 200 tactics skill when troops are sent to confront the enemy.", PartyRole.ArmyCommander, 0.005f, EffectIncrementType.AddFactor, "", PartyRole.None, 0f, EffectIncrementType.Invalid, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_rogueryNoRestForTheWicked.Initialize("{=RyfFWmDs}No Rest for the Wicked", DefaultSkills.Roguery, GetTierCost(1), _roguerySweetTalker, "{=yZarNiMq}{VALUE}% experience gain for bandits in your party.", PartyRole.PartyLeader, 0.2f, EffectIncrementType.AddFactor, "{=IqRNTls2}{VALUE}% raid speed.", PartyRole.PartyLeader, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		_roguerySweetTalker.Initialize("{=570wiYEe}Sweet Talker", DefaultSkills.Roguery, GetTierCost(1), _rogueryNoRestForTheWicked, "{=P3d4nn88}{VALUE}% chance for convincing bandits to leave in peace with barter.", PartyRole.PartyLeader, 0.2f, EffectIncrementType.AddFactor, "{=icyzOJZf}{VALUE}% prisoner escape chance in the governed settlement.", PartyRole.Governor, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_rogueryScarface.Initialize("{=XqSn5Uo0}Scarface", DefaultSkills.Roguery, GetTierCost(5), _rogueryWhiteLies, "{=FaGc9xR4}{VALUE}% chance for bandits, villagers and caravans to surrender.", PartyRole.Personal, 0.3f, EffectIncrementType.AddFactor, "{=1IYP1wHc}{VALUE}% chance per day to increase relation with a notable by 1 in the governed settlement.", PartyRole.Governor, 0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_rogueryDirtyFighting.Initialize("{=bb1hS9I4}Dirty Fighting", DefaultSkills.Roguery, GetTierCost(9), _rogueryArmsDealer, "{=bm3eSbBD}{VALUE}% stun duration for kicking.", PartyRole.Personal, 0.5f, EffectIncrementType.AddFactor, "{=iuCYTaMJ}{VALUE} random food item will be smuggled to the besieged governed settlement.", PartyRole.Governor, 2f, EffectIncrementType.Add, TroopUsageFlags.OnFoot | TroopUsageFlags.Melee, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_rogueryDashAndSlash.Initialize("{=w1B71sNj}Dash and Slash", DefaultSkills.Roguery, GetTierCost(10), _rogueryFleetFooted, "{=QiZfTNWJ}{VALUE}% damage bonus from speed while on foot.", PartyRole.Personal, 0.5f, EffectIncrementType.AddFactor, "{=hRCvgbQ5}{VALUE}% two handed weapon damage by troops in your formation.", PartyRole.Captain, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.TwoHandedUser, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_leadershipStoutDefender.Initialize("{=YogcurDJ}Stout Defender", DefaultSkills.Leadership, GetTierCost(2), _leadershipFerventAttacker, "{=qO1cJ3K9}{VALUE} starting battle morale when defending.", PartyRole.PartyLeader, 8f, EffectIncrementType.Add, "{=qItLTWR2}{VALUE}% recruitment rate of tier 4+ prisoners.", PartyRole.PartyLeader, 0.5f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.LandOnly);
		...
		_leadershipFamousCommander.Initialize("{=FQkHkMhw}Famous Commander", DefaultSkills.Leadership, GetTierCost(4), _leadershipLoyaltyAndHonor, "{=z4naITkR}{VALUE}% renown gain from battles.", PartyRole.Personal, 0.5f, EffectIncrementType.AddFactor, "{=CkJarFvq}{VALUE} experience to troops on recruitment.", PartyRole.Personal, 200f, EffectIncrementType.Add, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_tradeGranaryAccountant.Initialize("{=TFy2VYtM}Granary Accountant", DefaultSkills.Trade, GetTierCost(8), _tradeTradeyardForeman, "{=SyxQF0tM}{VALUE}% price penalty while selling food items.", PartyRole.PartyLeader, -0.2f, EffectIncrementType.AddFactor, "{=JnQcDyAz}{VALUE}% production rate to grain, olives, fish, date in villages bound to the governed settlement.", PartyRole.Governor, 0.2f, EffectIncrementType.AddFactor);
		_tradeTradeyardForeman.Initialize("{=QqKNxmeF}Tradeyard Foreman", DefaultSkills.Trade, GetTierCost(8), _tradeGranaryAccountant, "{=KgrnmR73}{VALUE}% price penalty while selling pottery, tools, silk and jewelry.", PartyRole.PartyLeader, -0.2f, EffectIncrementType.AddFactor, "{=mN3fLgtx}{VALUE}% production rate to clay, iron, silk and silver in villages bound to the governed settlement.", PartyRole.Governor, 0.2f, EffectIncrementType.AddFactor);
		...
		_stewardDrillSergant.Initialize("{=L9k4bovO}Drill Sergeant", DefaultSkills.Steward, GetTierCost(2), _stewardSevenVeterans, "{=UYhJZya5}{VALUE} daily experience to troops in your party.", PartyRole.Quartermaster, 2f, EffectIncrementType.Add, "{=B2msxAju}{VALUE}% garrison wages in the governed settlement.", PartyRole.Governor, -0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_stewardForcedLabor.Initialize("{=cWyqiNrf}Forced Labor", DefaultSkills.Steward, GetTierCost(8), _stewardContractors, "{=HrOTTjgo}Prisoners in your party provide carry capacity as if they are standard troops.", PartyRole.Quartermaster, 0f, EffectIncrementType.AddFactor, "{=T9Viygs8}{VALUE}% construction speed per every 3 prisoners.", PartyRole.Governor, 0.01f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_stewardArenicosMules.Initialize("{=qBx8UbUt}Arenicos' Mules", DefaultSkills.Steward, GetTierCost(9), _stewardArenicosHorses, "{=Yp4zv2ib}{VALUE}% carrying capacity for pack animals in your party.", PartyRole.Quartermaster, 0.2f, EffectIncrementType.AddFactor, "{=fswrp38u}{VALUE}% trade penalty for trading pack animals.", PartyRole.Quartermaster, -0.2f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.LandOnly);
		...
		_medicineSelfMedication.Initialize("{=TLGvIdJB}Self Medication", DefaultSkills.Medicine, GetTierCost(1), _medicinePreventiveMedicine, "{=bLAw2di4}{VALUE}% healing rate.", PartyRole.Personal, 0.3f, EffectIncrementType.AddFactor, "{=V53EYEXx}{VALUE}% combat movement speed.", PartyRole.Personal, 0.02f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.OnFoot, PerkObject.EffectEnvironment.NavalReduced, PerkObject.EffectEnvironment.NavalReduced);
		_medicinePreventiveMedicine.Initialize("{=wI393cla}Preventive Medicine", DefaultSkills.Medicine, GetTierCost(1), _medicineSelfMedication, "{=Ti9auMiO}{VALUE} hit points.", PartyRole.Personal, 5f, EffectIncrementType.Add, "{=10cVZTTm}{VALUE}% recovery of lost hit points after each battle.", PartyRole.Personal, 0.3f, EffectIncrementType.AddFactor, TroopUsageFlags.Any);
		_medicineTriageTent.Initialize("{=EU4JjLqV}Triage Tent", DefaultSkills.Medicine, GetTierCost(2), _medicineWalkItOff, "{=ZMPhsLdx}{VALUE}% healing rate when stationary on the campaign map.", PartyRole.Surgeon, 0.3f, EffectIncrementType.AddFactor, "{=Mn714dPH}{VALUE}% food consumption for besieged governed settlement.", PartyRole.Governor, -0.05f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_medicineWalkItOff.Initialize("{=0pyLfrGZ}Walk It Off", DefaultSkills.Medicine, GetTierCost(2), _medicineTriageTent, "{=NtCBRiLH}{VALUE}% healing rate when moving on the campaign map.", PartyRole.Surgeon, 0.15f, EffectIncrementType.AddFactor, "{=4YNqWPEu}{VALUE} hit points recovery after each offensive battle.", PartyRole.Personal, 10f, EffectIncrementType.Add, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_medicineDoctorsOath.Initialize("{=PAwDV08b}Doctor's Oath", DefaultSkills.Medicine, GetTierCost(3), _medicineSledges, "{=jEAMXTa6}Your medicine skill partially applies to enemy casualties, increasing potential prisoners.", PartyRole.Surgeon, 0f, EffectIncrementType.AddFactor, "{=Ti9auMiO}{VALUE} hit points.", PartyRole.Personal, 5f, EffectIncrementType.Add, TroopUsageFlags.Undefined, TroopUsageFlags.Any);
		_medicineBestMedicine.Initialize("{=ei1JSeco}Best Medicine", DefaultSkills.Medicine, GetTierCost(4), _medicineGoodLodging, "{=L3kTYA2p}{VALUE}% healing rate while party morale is above 60.", PartyRole.Surgeon, 0.15f, EffectIncrementType.AddFactor, "{=At6b9vHF}{VALUE} relationship per day with a random notable over age 40 when party is in a town.", PartyRole.Personal, 1f, EffectIncrementType.Add, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		...
		_medicineFortitudeTonic.Initialize("{=ib2SMG9b}Fortitude Tonic", DefaultSkills.Medicine, GetTierCost(9), _medicineCheatDeath, "{=v9NohO6l}{VALUE} hit points to other heroes in your party.", PartyRole.PartyLeader, 10f, EffectIncrementType.Add, "{=Ti9auMiO}{VALUE} hit points.", PartyRole.Personal, 5f, EffectIncrementType.Add, TroopUsageFlags.Any, TroopUsageFlags.Any);
		_medicineHelpingHands.Initialize("{=KavZKNaa}Helping Hands", DefaultSkills.Medicine, GetTierCost(10), _medicineBattleHardened, "{=6NOzUcGN}{VALUE}% troop recovery rate for every 10 troop in your party.", PartyRole.Surgeon, 0.02f, EffectIncrementType.AddFactor, "{=iHuzmdm2}{VALUE}% prosperity loss from starvation.", PartyRole.Governor, -0.5f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_medicineBattleHardened.Initialize("{=oSbRD72H}Battle Hardened", DefaultSkills.Medicine, GetTierCost(10), _medicineHelpingHands, "{=qWpabhp6}{VALUE} experience to wounded units at the end of the battle.", PartyRole.Surgeon, 25f, EffectIncrementType.Add, "{=3tLU4AG7}{VALUE}% siege attrition loss in the governed settlement.", PartyRole.Governor, -0.25f, EffectIncrementType.AddFactor, TroopUsageFlags.Undefined, TroopUsageFlags.Undefined, PerkObject.EffectEnvironment.NavalReduced);
		_medicineMinisterOfHealth.Initialize("{=rtTjuJTc}Minister of Health", DefaultSkills.Medicine, GetTierCost(11), null, "{=cwFyqrfv}{VALUE} hit point to troops for every skill point above 250.", PartyRole.Personal, 1f, EffectIncrementType.Add, "", PartyRole.None, 0f, EffectIncrementType.Invalid, TroopUsageFlags.Any);
