...
public struct Oriented2DArea
{
	...
	public Corners GetCorners()
	{
		...
		Vec2 topLeft = GlobalCenter - vec + vec2;
		Vec2 bottomLeft = GlobalCenter - vec - vec2;
		Vec2 bottomRight = GlobalCenter + vec - vec2;
		return new Corners(in topLeft, in topRight, in bottomLeft, in bottomRight);
	}
