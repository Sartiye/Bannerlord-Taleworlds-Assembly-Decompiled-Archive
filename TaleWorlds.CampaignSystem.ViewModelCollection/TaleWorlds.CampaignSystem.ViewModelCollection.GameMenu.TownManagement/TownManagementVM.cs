...
public class TownManagementVM : ViewModel
{
	...
	private void RefreshTownManagementStats()
	{
		...
		MiddleFirstTextList.Add(new TownManagementDescriptionItemVM(GameTexts.FindText("str_town_management_daily_production"), MathF.Round(Campaign.Current.Models.BuildingConstructionModel.CalculateDailyConstructionPower(_settlement.Town).ResultNumber), 0, TownManagementDescriptionItemVM.DescriptionType.Production, hint2));
		BasicTooltipViewModel hint3 = new BasicTooltipViewModel(() => CampaignUIHelper.GetTownProsperityTooltip(_settlement.Town));
		MiddleFirstTextList.Add(new TownManagementDescriptionItemVM(GameTexts.FindText("str_town_management_prosperity"), MathF.Round(_settlement.Town.Prosperity), MathF.Round(Campaign.Current.Models.SettlementProsperityModel.CalculateProsperityChange(_settlement.Town).ResultNumber), TownManagementDescriptionItemVM.DescriptionType.Prosperity, hint3));
		BasicTooltipViewModel hint4 = new BasicTooltipViewModel(() => CampaignUIHelper.GetTownFoodTooltip(_settlement.Town));
		MiddleFirstTextList.Add(new TownManagementDescriptionItemVM(GameTexts.FindText("str_town_management_food"), MathF.Round(_settlement.Town.FoodStocks), MathF.Round(Campaign.Current.Models.SettlementFoodModel.CalculateTownFoodStocksChange(_settlement.Town).ResultNumber), TownManagementDescriptionItemVM.DescriptionType.Food, hint4));
		BasicTooltipViewModel hint5 = new BasicTooltipViewModel(() => CampaignUIHelper.GetTownLoyaltyTooltip(_settlement.Town));
		MiddleSecondTextList.Add(new TownManagementDescriptionItemVM(GameTexts.FindText("str_town_management_loyalty"), MathF.Round(_settlement.Town.Loyalty), MathF.Round(Campaign.Current.Models.SettlementLoyaltyModel.CalculateLoyaltyChange(_settlement.Town).ResultNumber), TownManagementDescriptionItemVM.DescriptionType.Loyalty, hint5));
		BasicTooltipViewModel hint6 = new BasicTooltipViewModel(() => CampaignUIHelper.GetTownSecurityTooltip(_settlement.Town));
		MiddleSecondTextList.Add(new TownManagementDescriptionItemVM(GameTexts.FindText("str_town_management_security"), MathF.Round(_settlement.Town.Security), MathF.Round(Campaign.Current.Models.SettlementSecurityModel.CalculateSecurityChange(_settlement.Town).ResultNumber), TownManagementDescriptionItemVM.DescriptionType.Security, hint6));
		BasicTooltipViewModel hint7 = new BasicTooltipViewModel(() => CampaignUIHelper.GetTownMilitiaTooltip(_settlement.Town));
		MiddleSecondTextList.Add(new TownManagementDescriptionItemVM(GameTexts.FindText("str_town_management_militia"), MathF.Round(_settlement.Militia), MathF.Round(Campaign.Current.Models.SettlementMilitiaModel.CalculateMilitiaChange(_settlement).ResultNumber), TownManagementDescriptionItemVM.DescriptionType.Militia, hint7));
