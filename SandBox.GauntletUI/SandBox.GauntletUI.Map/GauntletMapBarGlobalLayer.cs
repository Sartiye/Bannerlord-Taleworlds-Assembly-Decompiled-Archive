...
public class GauntletMapBarGlobalLayer : GlobalLayer
{
	...
	private MapBarShortcuts GetMapBarShortcuts()
	{
		...
		result.FastForwardHotkey = Game.Current.GameTextManager.GetHotKeyGameText("MapHotKeyCategory", 62).ToString();
		result.PauseHotkey = Game.Current.GameTextManager.GetHotKeyGameText("MapHotKeyCategory", 60).ToString();
		result.PlayHotkey = Game.Current.GameTextManager.GetHotKeyGameText("MapHotKeyCategory", 61).ToString();
		return result;
	}
