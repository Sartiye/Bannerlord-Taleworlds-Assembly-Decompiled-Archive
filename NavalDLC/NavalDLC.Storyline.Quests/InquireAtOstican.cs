...
public class InquireAtOstican : QuestBase
{
	...
	private void AddNorthernerDialog()
	{
		...
		dialogFlow.AddDialogLine("northerner_meet_dialog_start_before_met", "start", "northerner_meet_dialog_player_options", "{=ay0tHozl}Aye? So who're you, then?", northerner_meet_dialog_start_before_met_on_condition, null, this, 1200);
		...
		dialogFlow.AddDialogLine("northerner_meet_dialog_continue_1_line", "northerner_meet_dialog_continue", "northerner_meet_dialogue_continue_2", "{=4K9ycbC8}A fight, you say… I take it that Gunnar and you won?", null, null, this);
		...
		dialogFlow.AddDialogLine("northerner_quest_options_2_continue_1", "northerner_quest_options_2_answer_1", "northerner_quest_options_2_answer_2", "{=sfuFR9fr}I did, I did. We started out as young men with nothing but our swords, our sweet mistress the sea whispering promises of wealth and glory in our ears... We served no kings and had no lords. Those were fine times!", null, null, this);
		...
		dialogFlow.AddDialogLine("northerner_quest_options_3_continue", "northerner_quest_options_3_answer", "close_window", "{=5LbipyXT}Come down to the ship with me, then! Wind and tide are with us, and I won't tarry long.", null, northerner_quest_options_3_continue_on_consequence, this);
		...
		dialogFlow.AddDialogLine("northerner_quest_options_4_continue", "northerner_quest_options_4_answer", "close_window", "{=s9Rz14CU}Are you sure you're cut out for a life at sea? Make haste when wind and tide are with you, friend! Anyway, come back when you're ready.", null, null, this);
