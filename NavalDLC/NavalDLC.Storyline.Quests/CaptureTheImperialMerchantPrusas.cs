...
public class CaptureTheImperialMerchantPrusas : NavalStorylineQuestBase
{
	...
	{
		TextObject npcText = new TextObject("{=A1e4qar9}Did you see that big fiery ball? Not very accurate, I’ll warrant, but if one of our ships gets hit by one of those… Those who don’t jump into the sea in time will die a nasty death.");
		TextObject npcText2 = new TextObject("{=sawnbWQP}I’ve heard Crusas does this… He doesn’t try to maneuver or run, but lashes his ships together, building himself a floating fortress. He mounts mangonels on them, and peppers any attackers with flaming pitch. Not a bad tactic, if you’ve got the time to prepare and you just want to be left alone. Most attackers will keep their distance and look for easier prey.");
		...
		TextObject npcText3 = new TextObject("{=G5gTXNKi}If all our ships row in together, we’d be presenting enough targets that we’re bound to get hit. So let’s not do that. Here’s another idea…");
		...
		TextObject npcText5 = new TextObject("{=kW7yU5CE}I saw you handle that fireship at Omor, and I think you’re the one to take the helm. I’ll come with you though, to keep my men rowing briskly.");
		...
		TextObject npcText6 = new TextObject("{=DaYQ2dm8}That was a good fight! You did a fine job taking out those mangonels.");
		...
		TextObject npcText9 = new TextObject("{=1aHDn1cc}I am Salautas Crusas. I sail under the protection of the Sea Hounds. If you kill me, it will not go well for you.");
		...
		TextObject npcText10 = new TextObject("{=edUrD21k}Yes, I buy slaves. They work my sulfur mines. Sulfur is valuable, and if I did not mine it another would. Anyway, these islands are part of no kingdom and I am violating no law. Since when does a pirate like yourself care about such things?");
		...
		TextObject textObject = new TextObject("{=hp67Xmzj}So then… I believe I have heard of you. {PLAYER.NAME}? Purig spoke of you. From what I know, I think I can be of use to you. Do we have a bargain? I tell you what I know, and you give my freedom.");
		...
		TextObject npcText11 = new TextObject("{=l8XH22F7}So then. When I last spoke to Purig, I saw your sister among his captives, and tried to buy her. ‘Not that one,’ he said. ‘That’s my insurance against a pair of avenging furies.’ I think he grudgingly admired how persistently you pursued him.");
		...
		TextObject npcText13 = new TextObject("{=blWf6oTJ}So.. I can tell you how to find Purig, which means you’ve found your sister as well. But if you harm me, it’s likely you’ll never have such a chance again. So I repeat - do we have a bargain? ");
		...
		TextObject npcText15 = new TextObject("{=Yj4RhLbo}Were you to be one of these buyers?");
		TextObject npcText16 = new TextObject("{=kh5HVkT1}Among others, yes.");
		TextObject npcText17 = new TextObject("{=G7ekdQvI}Good. Then we will take your ship. It has fine lines and expensive fittings, and I have no doubt that Purig, who has an eye for costly things, would recognize it instantly");
		...
		TextObject npcText18 = new TextObject("{=0L1ZKRk4}We shall need to think on this, but it might even be good to keep Crusas with us, to converse with Purig or his crew.");
		TextObject npcText19 = new TextObject("{=QmIfTGw4}Good news, Crusas! You are indeed worth more to us alive than dead, for now.");
		TextObject npcText20 = new TextObject("{=SsAit4jx}For now, you say. What, might I ask, is to be my fate?");
		...
		TextObject npcText21 = new TextObject("{=uUrrMnad}Well, that’s decided then. We should return to Ostican to refit and gather our allies, then prepare to sail for Angranfjord.");
