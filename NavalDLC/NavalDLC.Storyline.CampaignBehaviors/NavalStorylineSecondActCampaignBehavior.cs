...
public class NavalStorylineSecondActCampaignBehavior : CampaignBehaviorBase
{
	...
	{
		Campaign.Current.ConversationManager.AddDialogFlow(DialogFlow.CreateDialogFlow("start", 1200).NpcLine("{=LI75U7wB}Well, I sent off my letter, and I spoke to some men from my homeland who have just arrived. They are sick of Sea Hound raids, and ready to join us in our hunt. I am afraid we cannot take your own companions, however. There's not enough room on the ship, and my men aren't willing to trust their lives to any other vessel in these northern seas.").Condition(() => IsAct2ReadyToStart(NavalStorylineData.Gunnar) && !_isIntroGiven)
			...
			.NpcLine("{=jzVnKuMC}The ones with us now are farmers from the island of Beinland, near my village at Lagshofn. They are good men, and well-motivated. That coast has suffered greatly at the hands of the Sea Hounds. But they are not warriors who live for battle.")
			...
			.NpcLine("{=n6VFFFoU}I suppose I have time for an old war story or two, if you're truly of a mind to hear…")
			...
			.NpcLine("{=hnSqEnxu}Some of our number never showed up at the battle, however. I can imagine how it went for them after that - mocked in taverns or in scraps of songs sung by children.")
			...
			.NpcLine("{=IV6FiJW4}I do not know for sure. If I had ever knowingly given him insult, I never would have sailed on his ship.")
			.NpcLine("{=1Aq78OZl}A true warrior, to my mind, knows his own mettle. He does not need others to remind of his honor. He knows that sometimes in war you suffer bad luck - your ship arrived late, you were carried away in the rush of a rout, you were defeated by a king with forces far greater than your own.")
			...
			.EndPlayerOptions()
			.CloseDialog());
		Campaign.Current.ConversationManager.AddDialogFlow(DialogFlow.CreateDialogFlow("start", 1200).NpcLine("{=7NQsM70B}Are you ready to deal with those two Sea Hound vessels?").Condition(() => IsAct2ReadyToStart(NavalStorylineData.Gunnar) && _isIntroGiven)
			.BeginPlayerOptions()
