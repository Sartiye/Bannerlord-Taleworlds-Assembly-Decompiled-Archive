...
public class NavalFloatsamLogic : MissionLogic
{
	...
	public void RegisterFloatsamInstance(GameEntity entity)
	{
		...
		FloatSamRecord item2 = default(FloatSamRecord);
		item2.FloatsamEntity = entity;
		item2.DeSpawnTimer = new Timer(Mission.Current.CurrentTime, MBRandom.RandomFloatRanged(10f, 15f));
