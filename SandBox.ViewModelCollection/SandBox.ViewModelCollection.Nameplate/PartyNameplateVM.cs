...
public class PartyNameplateVM : NameplateVM
{
	...
	private void AddQuestBindFlagsForParty(MobileParty party)
	{
		...
		if (((_questsBind & CampaignUIHelper.IssueQuestFlags.TrackedStoryQuest) != 0 || (_questsBind & CampaignUIHelper.IssueQuestFlags.ActiveIssue) != 0) && (_questsBind & CampaignUIHelper.IssueQuestFlags.ActiveStoryQuest) != 0)
		{
			return;
		}
