...
public class MissionAgentMarkerTargetVM : MissionNameMarkerTargetVM<Agent>
{
	...
	public void UpdateQuestStatus()
	{
		...
		{
			if (questFlag != 0 && (issueQuestFlags & questFlag) != 0 && base.Quests.AllQ((QuestMarkerVM q) => q.IssueQuestFlag != questFlag))
			{
				base.Quests.Add(new QuestMarkerVM(questFlag));
				if ((questFlag & CampaignUIHelper.IssueQuestFlags.ActiveIssue) != 0 && (questFlag & CampaignUIHelper.IssueQuestFlags.AvailableIssue) != 0 && (questFlag & CampaignUIHelper.IssueQuestFlags.TrackedIssue) != 0)
				{
					base.IsTracked = true;
				}
				else if ((questFlag & CampaignUIHelper.IssueQuestFlags.ActiveIssue) != 0 && (questFlag & CampaignUIHelper.IssueQuestFlags.ActiveStoryQuest) != 0 && (questFlag & CampaignUIHelper.IssueQuestFlags.TrackedStoryQuest) != 0)
				{
