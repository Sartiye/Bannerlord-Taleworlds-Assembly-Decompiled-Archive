...
public class MapBar__TaleWorlds_CampaignSystem_ViewModelCollection_Map_MapBar_MapBarVM_Dependency_4_ItemTemplate : ListPanel
{
	private ListPanel _widget;

	private IconBrushWidget _widget_0;

	private MapBarCustomValueTextWidget _widget_1;
	...
	public void CreateWidgets()
	{
		...
		_widget_1 = new MapBarCustomValueTextWidget(base.Context);
	...
	public void SetAttributes()
	{
		...
		_widget_0.IconBrush = base.Context.GetBrush("MapBar.Right.Icons");
		_widget_0.UseStylesFromSourceIcon = true;
		_widget_1.WidthSizePolicy = SizePolicy.CoverChildren;
		_widget_1.HeightSizePolicy = SizePolicy.Fixed;
		_widget_1.MinWidth = 20f;
		_widget_1.MaxWidth = 52f;
		_widget_1.SuggestedHeight = 40f;
		_widget_1.VerticalAlignment = VerticalAlignment.Center;
		_widget_1.PositionYOffset = 2f;
		_widget_1.Brush = base.Context.GetBrush("MapTextBrushWithAnim");
		_widget_1.Brush.FontSize = 20;
		_widget_1.NormalColor = new Color(0.9568628f, 0.882353f, 0.7686275f);
		_widget_1.WarningColor = new Color(0.8588236f, 0.03137255f, 0.03137255f);
	...
	private void HandleWidgetPropertyChangeOf_widget_0(string propertyName)
	{
		...
		{
			_datasource_Root.VisualId = _widget_0.IconID;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_1(string propertyName)
	{
		...
		{
		case "IsWarning":
			_datasource_Root.HasWarning = _widget_1.IsWarning;
			break;
		case "Text":
			_datasource_Root.Value = _widget_1.Text;
			break;
		case "ValueAsInt":
			_datasource_Root.IntValue = _widget_1.ValueAsInt;
			break;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		...
		{
		case "VisualId":
			_widget_0.IconID = _datasource_Root.VisualId;
			break;
		case "HasWarning":
			_widget_1.IsWarning = _datasource_Root.HasWarning;
			break;
		case "Value":
			_widget_1.Text = _datasource_Root.Value;
			break;
		case "IntValue":
			_widget_1.ValueAsInt = _datasource_Root.IntValue;
			break;
		}
	}
