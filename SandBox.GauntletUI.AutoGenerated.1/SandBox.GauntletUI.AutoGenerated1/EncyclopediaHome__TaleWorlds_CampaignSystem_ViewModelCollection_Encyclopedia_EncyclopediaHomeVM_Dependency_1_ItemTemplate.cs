...
public class EncyclopediaHome__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_EncyclopediaHomeVM_Dependency_1_ItemTemplate : ButtonWidget
{
	...
	public void SetAttributes()
	{
		...
		_widget_0.Brush = base.Context.GetBrush("EncyclopediaHome.Type.Text");
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		...
		{
			if (_datasource_Root.ImageID != null)
			{
				_widget.Brush = base.Context.BrushFactory.GetBrush(_datasource_Root.ImageID);
			}
		}
