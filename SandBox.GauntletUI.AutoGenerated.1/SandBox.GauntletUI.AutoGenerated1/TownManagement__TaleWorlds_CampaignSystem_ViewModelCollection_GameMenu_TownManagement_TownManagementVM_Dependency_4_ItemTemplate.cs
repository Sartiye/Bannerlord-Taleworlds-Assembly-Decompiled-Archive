...
public class TownManagement__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_TownManagement_TownManagementVM_Dependency_4_ItemTemplate : ListPanel
{
	private ListPanel _widget;

	private TextWidget _widget_0;

	private SettlementStatTextWidget _widget_1;

	private ChangeAmountTextWidget _widget_2;

	private DescriptionItemVisualBrushWidget _widget_3;
	...
	public void CreateWidgets()
	{
		...
		_widget_1 = new SettlementStatTextWidget(base.Context);
		_widget.AddChild(_widget_1);
		_widget_2 = new ChangeAmountTextWidget(base.Context);
		_widget.AddChild(_widget_2);
		_widget_3 = new DescriptionItemVisualBrushWidget(base.Context);
	...
	public void SetAttributes()
	{
		...
		_widget_0.Brush = base.Context.GetBrush("TownManagement.Description.Title.Text");
		...
		_widget_1.Brush = base.Context.GetBrush("TownManagement.Description.Value.Text");
		_widget_2.WidthSizePolicy = SizePolicy.CoverChildren;
		_widget_2.HeightSizePolicy = SizePolicy.CoverChildren;
		_widget_2.MaxWidth = 80f;
		_widget_2.HorizontalAlignment = HorizontalAlignment.Center;
		_widget_2.VerticalAlignment = VerticalAlignment.Center;
		_widget_2.Brush = base.Context.GetBrush("Settlement.Property.PositiveChange.Text");
		_widget_2.NegativeBrushName = "TownManagement.Property.NegativeChange.Text";
		_widget_2.PositiveBrushName = "TownManagement.Property.PositiveChange.Text";
		_widget_2.UseParentheses = true;
		_widget_3.WidthSizePolicy = SizePolicy.Fixed;
		_widget_3.HeightSizePolicy = SizePolicy.Fixed;
		_widget_3.SuggestedWidth = 30f;
		_widget_3.SuggestedHeight = 30f;
		_widget_3.VerticalAlignment = VerticalAlignment.Center;
		_widget_3.Brush = base.Context.GetBrush("TownManamgement.Description.Type.Brush");
	...
	private void HandleWidgetPropertyChangeOf_widget_1(string propertyName)
	{
		...
		{
			_datasource_Root.IsWarning = _widget_1.IsWarning;
		}
		else if (propertyName == "IntText")
		{
			_datasource_Root.Value = _widget_1.IntText;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_2(string propertyName)
	{
		...
		{
			_datasource_Root.ValueChange = _widget_2.Amount;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_3(string propertyName)
	{
		...
		{
			_datasource_Root.Type = _widget_3.Type;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		...
		case "Title":
			...
			break;
		case "IsWarning":
			_widget_1.IsWarning = _datasource_Root.IsWarning;
			break;
		case "Value":
			_widget_1.IntText = _datasource_Root.Value;
			break;
		case "ValueChange":
			_widget_2.Amount = _datasource_Root.ValueChange;
			break;
		case "Type":
			_widget_3.Type = _datasource_Root.Type;
			break;
		}
	}
