...
public class SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_10_GameMenuPartyItem__InheritedPrefab : GameMenuPartyItemButtonWidget
{
	...
	public SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_10_GameMenuPartyItem__InheritedPrefab(UIContext context)
		: base(context)
	{
	}
	...
	public virtual void DestroyDataSource()
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int num = _widget_0_3.ChildCount - 1; num >= 0; num--)
			{
				...
				((SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate)child).OnBeforeRemovedChild(child);
				((SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate)_widget_0_3.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_QuestsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.Reset:
		{
			for (int num = _widget_0_3.ChildCount - 1; num >= 0; num--)
			{
				...
				((SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate)child3).OnBeforeRemovedChild(child3);
				Widget child4 = _widget_0_3.GetChild(num);
				((SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate)child4).SetDataSource(null);
		...
		{
			SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate = new SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate(base.Context);
			GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate);
			QuestMarkerVM dataSource = (QuestMarkerVM)(generatedWidgetData.Data = _datasource_Root_Quests[e.NewIndex]);
			settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.AddComponent(generatedWidgetData);
			_widget_0_3.AddChildAtIndex(settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate, e.NewIndex);
			settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.CreateWidgets();
			settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.SetIds();
			settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.SetAttributes();
			settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_0_3.GetChild(e.NewIndex);
			((SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_0_3.GetChild(e.NewIndex);
			((SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(GameMenuPartyItemVM newDataSource)
	{
		if (_datasource_Root != null)
		{
			...
			if (_datasource_Root_Quests != null)
			{
				...
				for (int num = _widget_0_3.ChildCount - 1; num >= 0; num--)
				{
					...
					((SettlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate)child2).SetDataSource(null);
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Quests.Count; i++)
			{
				...
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_3.AddChildAtIndex(settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate, i);
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.CreateWidgets();
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.SetIds();
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.SetAttributes();
				settlementOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_SettlementMenuOverlayVM_Dependency_16_ItemTemplate.SetDataSource(dataSource);
