...
public class EncyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_4_EncyclopediaFilterGroup__InheritedPrefab : Widget
{
	...
	public virtual void DestroyDataSource()
	{
		...
		if (_datasource_Root_Filters != null)
		{
			...
			for (int num = _widget_3.ChildCount - 1; num >= 0; num--)
			{
				...
				((EncyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate)_widget_3.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_FiltersChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_3.AddChildAtIndex(encyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate, e.NewIndex);
		...
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			...
			((EncyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_3.GetChild(e.NewIndex);
			((EncyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(EncyclopediaFilterGroupVM newDataSource)
	{
		...
		if (_datasource_Root_Filters != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Filters.Count; i++)
			{
				...
				encyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_3.AddChildAtIndex(encyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate, i);
				encyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate.CreateWidgets();
				encyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate.SetIds();
				encyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate.SetAttributes();
				encyclopediaItemList__TaleWorlds_CampaignSystem_ViewModelCollection_Encyclopedia_Pages_EncyclopediaPageVM_Dependency_7_ItemTemplate.SetDataSource(dataSource);
