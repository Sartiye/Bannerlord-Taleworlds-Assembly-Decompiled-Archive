...
public class PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_28_ItemTemplate : ButtonWidget
{
		...
		if (_datasource_Root_Upgrades != null)
		{
			...
			if (_datasource_Root_Upgrades_UpgradeSlots != null)
			{
				...
				for (int num = _widget_4.ChildCount - 1; num >= 0; num--)
				{
					...
					((PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate)child).OnBeforeRemovedChild(child);
					((PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate)_widget_4.GetChild(num)).DestroyDataSource();
				}
	...
	public void OnList_datasource_Root_Upgrades_UpgradeSlotsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.Reset:
		{
			for (int num = _widget_4.ChildCount - 1; num >= 0; num--)
			{
				...
				((PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate)child3).OnBeforeRemovedChild(child3);
				Widget child4 = _widget_4.GetChild(num);
				((PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate)child4).SetDataSource(null);
		...
		{
			PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate = new PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate(base.Context);
			GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate);
			...
			portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.AddComponent(generatedWidgetData);
			_widget_4.AddChildAtIndex(portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate, e.NewIndex);
			portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.CreateWidgets();
			portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.SetIds();
			portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.SetAttributes();
			portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_4.GetChild(e.NewIndex);
			((PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_4.GetChild(e.NewIndex);
			((PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(ShipItemVM newDataSource)
	{
			...
			if (_datasource_Root_Upgrades != null)
			{
				...
				if (_datasource_Root_Upgrades_UpgradeSlots != null)
				{
					...
					for (int num = _widget_4.ChildCount - 1; num >= 0; num--)
					{
						...
						((PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate)child2).SetDataSource(null);
		...
		if (_datasource_Root_Upgrades_UpgradeSlots != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Upgrades_UpgradeSlots.Count; i++)
			{
				...
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_4.AddChildAtIndex(portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate, i);
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.CreateWidgets();
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.SetIds();
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.SetAttributes();
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_33_ItemTemplate.SetDataSource(dataSource);
