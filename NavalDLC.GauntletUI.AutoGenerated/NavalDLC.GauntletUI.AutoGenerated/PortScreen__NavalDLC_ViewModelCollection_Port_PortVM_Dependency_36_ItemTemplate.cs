...
public class PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_36_ItemTemplate : RichTextWidget
{
	private RichTextWidget _widget;

	private PortShipPropertyVM _datasource_Root;

	public PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_36_ItemTemplate(UIContext context)
		: base(context)
	{
	}
	...
	public void SetAttributes()
	{
		...
		base.MarginTop = 10f;
		base.Brush = base.Context.GetBrush("ClanCardSelectionPopup.Property.Text");
	}
	...
	public void SetDataSource(PortShipPropertyVM dataSource)
	{
	...
	private void HandleWidgetPropertyChangeOf_widget(string propertyName)
	{
		...
		{
			_datasource_Root.Text = _widget.Text;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		if (propertyName == "Text")
		{
			_widget.Text = _datasource_Root.Text;
		}
	}

	private void RefreshDataSource_datasource_Root(PortShipPropertyVM newDataSource)
	{
		if (_datasource_Root != null)
		{
			_datasource_Root.PropertyChanged -= ViewModelPropertyChangedListenerOf_datasource_Root;
