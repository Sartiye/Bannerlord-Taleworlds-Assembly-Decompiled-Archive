...
public class PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_26_ItemTemplate : ButtonWidget
{
		...
		if (_datasource_Root_Upgrades != null)
		{
			...
			if (_datasource_Root_Upgrades_UpgradeSlots != null)
			{
				...
				for (int num = _widget_4.ChildCount - 1; num >= 0; num--)
				{
					...
					((PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_29_ItemTemplate)_widget_4.GetChild(num)).DestroyDataSource();
				}
	...
	public void OnList_datasource_Root_Upgrades_UpgradeSlotsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_4.AddChildAtIndex(portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_29_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(ShipItemVM newDataSource)
	{
		...
		if (_datasource_Root_Upgrades_UpgradeSlots != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Upgrades_UpgradeSlots.Count; i++)
			{
				...
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_29_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_4.AddChildAtIndex(portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_29_ItemTemplate, i);
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_29_ItemTemplate.CreateWidgets();
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_29_ItemTemplate.SetIds();
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_29_ItemTemplate.SetAttributes();
				portScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_29_ItemTemplate.SetDataSource(dataSource);
