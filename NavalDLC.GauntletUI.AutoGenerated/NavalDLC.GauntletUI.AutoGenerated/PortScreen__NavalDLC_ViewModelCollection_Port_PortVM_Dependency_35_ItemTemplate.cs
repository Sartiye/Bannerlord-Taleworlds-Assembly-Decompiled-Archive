...
public class PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_35_ItemTemplate : Widget
{
	...
	public PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_35_ItemTemplate(UIContext context)
		: base(context)
	{
	}
