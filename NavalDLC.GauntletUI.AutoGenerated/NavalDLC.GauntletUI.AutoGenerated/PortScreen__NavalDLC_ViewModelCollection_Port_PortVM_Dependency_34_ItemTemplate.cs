...
public class PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_34_ItemTemplate : Widget
{
	...
	public PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_34_ItemTemplate(UIContext context)
		: base(context)
	{
	}
