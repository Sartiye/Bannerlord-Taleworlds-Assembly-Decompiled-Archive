...
public class PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_12_PortShipList__DependendPrefab : Widget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_LeftRoster != null)
		{
			...
			if (_datasource_Root_LeftRoster_Ships != null)
			{
	...
	private void HandleWidgetPropertyChangeOf_widget(string propertyName)
	{
		...
		{
			_datasource_Root_LeftRoster.IsSelected = _widget.IsVisible;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_0(string propertyName)
	{
		...
		{
			_datasource_Root_LeftRoster.HasNoShipsText = _widget_0.Text;
		}
		else if (propertyName == "IsHidden")
		{
			_datasource_Root_LeftRoster.HasAnyShips = _widget_0.IsHidden;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_1_0(string propertyName)
	{
		if (propertyName == "IsVisible")
		{
			_datasource_Root_LeftRoster.HasAnyShips = _widget_1_0.IsVisible;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_2(string propertyName)
	{
		if (propertyName == "IsVisible")
		{
			_datasource_Root_LeftRoster.HasMultipleShips = _widget_2.IsVisible;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root_LeftRoster(string propertyName)
	{
		...
		{
		case "Ships":
			RefreshDataSource_datasource_Root_LeftRoster_Ships(_datasource_Root_LeftRoster.Ships);
			break;
		case "IsSelected":
			_widget.IsVisible = _datasource_Root_LeftRoster.IsSelected;
			break;
		case "HasNoShipsText":
			_widget_0.Text = _datasource_Root_LeftRoster.HasNoShipsText;
			break;
		case "HasAnyShips":
			_widget_0.IsHidden = _datasource_Root_LeftRoster.HasAnyShips;
			_widget_1_0.IsVisible = _datasource_Root_LeftRoster.HasAnyShips;
			break;
		case "HasMultipleShips":
			_widget_2.IsVisible = _datasource_Root_LeftRoster.HasMultipleShips;
			break;
		}
	}
	...
	public void OnList_datasource_Root_LeftRoster_ShipsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.Sorted:
		{
			...
			{
				ShipItemVM bindingObject = _datasource_Root_LeftRoster_Ships[i];
	...
	private void RefreshDataSource_datasource_Root_LeftRoster(ShipRosterVM newDataSource)
	{
		...
		_widget_2.uintPropertyChanged += uintPropertyChangedListenerOf_widget_2;
		_widget_2.ColorPropertyChanged += ColorPropertyChangedListenerOf_widget_2;
		_datasource_Root_LeftRoster_Ships = _datasource_Root_LeftRoster.Ships;
		if (_datasource_Root_LeftRoster_Ships != null)
		{
			_datasource_Root_LeftRoster_Ships.ListChanged += OnList_datasource_Root_LeftRoster_ShipsChanged;
			for (int i = 0; i < _datasource_Root_LeftRoster_Ships.Count; i++)
	...
	private void RefreshDataSource_datasource_Root_LeftRoster_Ships(MBBindingList<ShipItemVM> newDataSource)
	{
		...
		_datasource_Root_LeftRoster_Ships = newDataSource;
		_datasource_Root_LeftRoster_Ships = _datasource_Root_LeftRoster.Ships;
		if (_datasource_Root_LeftRoster_Ships != null)
		{
			_datasource_Root_LeftRoster_Ships.ListChanged += OnList_datasource_Root_LeftRoster_ShipsChanged;
