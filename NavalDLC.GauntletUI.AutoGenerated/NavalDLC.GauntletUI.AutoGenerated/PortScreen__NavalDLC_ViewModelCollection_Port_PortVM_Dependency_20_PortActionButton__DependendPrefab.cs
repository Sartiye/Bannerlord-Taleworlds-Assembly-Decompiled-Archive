...
public class PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_20_PortActionButton__DependendPrefab : Widget
{
	...
	public PortScreen__NavalDLC_ViewModelCollection_Port_PortVM_Dependency_20_PortActionButton__DependendPrefab(UIContext context)
		: base(context)
	{
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_0_1_0_1(string propertyName)
	{
		if (propertyName == "Text")
		{
			_datasource_Root_SellAction.AdditionalInfo = _widget_0_1_0_1.Text;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root_SellAction(string propertyName)
	{
		...
		case "AdditionalInfo":
			...
			_widget_0_1_0_1.Text = _datasource_Root_SellAction.AdditionalInfo;
			break;
		case "Name":
