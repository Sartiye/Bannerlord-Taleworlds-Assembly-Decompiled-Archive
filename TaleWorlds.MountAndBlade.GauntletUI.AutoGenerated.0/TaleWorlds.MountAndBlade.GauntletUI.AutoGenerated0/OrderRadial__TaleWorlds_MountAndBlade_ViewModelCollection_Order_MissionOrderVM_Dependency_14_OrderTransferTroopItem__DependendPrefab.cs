...
public class OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_14_OrderTransferTroopItem__DependendPrefab : OrderTroopItemBrushWidget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_ActiveFormationClasses != null)
		{
			...
			for (int num = _widget_1.ChildCount - 1; num >= 0; num--)
			{
				...
				((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate)child).OnBeforeRemovedChild(child);
				((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate)_widget_1.GetChild(num)).DestroyDataSource();
			}
		...
		if (_datasource_Root_ActiveFilters != null)
		{
			...
			for (int num2 = _widget_6.ChildCount - 1; num2 >= 0; num2--)
			{
				...
				((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate)_widget_6.GetChild(num2)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_ActiveFormationClassesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.Reset:
		{
			for (int num = _widget_1.ChildCount - 1; num >= 0; num--)
			{
				...
				((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate)child3).OnBeforeRemovedChild(child3);
				Widget child4 = _widget_1.GetChild(num);
				((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate)child4).SetDataSource(null);
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate);
			...
			orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate.AddComponent(generatedWidgetData);
			_widget_1.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate, e.NewIndex);
		...
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			...
			((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_1.GetChild(e.NewIndex);
			((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate)child).SetDataSource(null);
	...
	public void OnList_datasource_Root_ActiveFiltersChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_6.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(OrderTroopItemVM newDataSource)
	{
		if (_datasource_Root != null)
		{
			...
			if (_datasource_Root_ActiveFormationClasses != null)
			{
				...
				for (int num = _widget_1.ChildCount - 1; num >= 0; num--)
				{
					...
					((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate)child2).SetDataSource(null);
		...
		if (_datasource_Root_ActiveFormationClasses != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ActiveFormationClasses.Count; i++)
			{
				...
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_1.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate, i);
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate.CreateWidgets();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate.SetIds();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate.SetAttributes();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_16_ItemTemplate.SetDataSource(dataSource);
		...
		if (_datasource_Root_ActiveFilters != null)
		{
			...
			{
				OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate = new OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate(base.Context);
				GeneratedWidgetData generatedWidgetData2 = new GeneratedWidgetData(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate);
				OrderTroopItemFilterVM dataSource2 = (OrderTroopItemFilterVM)(generatedWidgetData2.Data = _datasource_Root_ActiveFilters[j]);
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.AddComponent(generatedWidgetData2);
				_widget_6.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate, j);
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.CreateWidgets();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.SetIds();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.SetAttributes();
	...
	private void RefreshDataSource_datasource_Root_ActiveFilters(MBBindingList<OrderTroopItemFilterVM> newDataSource)
	{
		...
		if (_datasource_Root_ActiveFilters != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ActiveFilters.Count; i++)
			{
				...
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_6.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate, i);
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.CreateWidgets();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.SetIds();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.SetAttributes();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_17_ItemTemplate.SetDataSource(dataSource);
