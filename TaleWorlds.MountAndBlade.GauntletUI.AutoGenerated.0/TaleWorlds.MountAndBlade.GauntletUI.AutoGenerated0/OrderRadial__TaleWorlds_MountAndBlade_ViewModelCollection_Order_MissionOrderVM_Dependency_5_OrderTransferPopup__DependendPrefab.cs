...
public class OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_5_OrderTransferPopup__DependendPrefab : Widget
{
	...
	public void CreateWidgets()
	{
		...
		_widget_1 = new OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_14_Standard_TriplePopupCloseButtons__DependendPrefab(base.Context);
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_TransferTargetList != null)
		{
			...
			for (int num = _widget_0_0_2.ChildCount - 1; num >= 0; num--)
			{
				...
				((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_ItemTemplate)_widget_0_0_2.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_TransferTargetListChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_0_2.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(MissionOrderTroopControllerVM newDataSource)
	{
		...
		if (_datasource_Root_TransferTargetList != null)
		{
			...
			for (int i = 0; i < _datasource_Root_TransferTargetList.Count; i++)
			{
				...
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_0_2.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_ItemTemplate, i);
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_ItemTemplate.CreateWidgets();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_ItemTemplate.SetIds();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_ItemTemplate.SetAttributes();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_ItemTemplate.SetDataSource(dataSource);
