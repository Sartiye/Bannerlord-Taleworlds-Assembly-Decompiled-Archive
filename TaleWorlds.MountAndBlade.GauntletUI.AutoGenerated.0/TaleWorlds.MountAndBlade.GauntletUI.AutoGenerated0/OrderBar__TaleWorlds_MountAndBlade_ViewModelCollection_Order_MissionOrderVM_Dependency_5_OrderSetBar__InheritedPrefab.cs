...
public class OrderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_5_OrderSetBar__InheritedPrefab : Widget
{
	...
	{
		_widget = this;
		_widget_0 = new OrderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_13_OrderItemBar__DependendPrefab(base.Context);
	...
	public virtual void DestroyDataSource()
	{
		...
		if (_datasource_Root_Orders != null)
		{
			...
			for (int num = _widget_2_0.ChildCount - 1; num >= 0; num--)
			{
				...
				((OrderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate)_widget_2_0.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_OrdersChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_2_0.AddChildAtIndex(orderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(OrderSetVM newDataSource)
	{
		...
		if (_datasource_Root_Orders != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Orders.Count; i++)
			{
				...
				orderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_2_0.AddChildAtIndex(orderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate, i);
				orderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.CreateWidgets();
				orderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetIds();
				orderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetAttributes();
				orderBar__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetDataSource(dataSource);
