...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_13_CraftingOrderPopup__DependendPrefab : Widget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_CraftingOrders != null)
		{
			...
			for (int num = _widget_1_0_4_2_0_0.ChildCount - 1; num >= 0; num--)
			{
				...
				((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_28_ItemTemplate)_widget_1_0_4_2_0_0.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_CraftingOrdersChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_1_0_4_2_0_0.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_28_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(CraftingOrderPopupVM newDataSource)
	{
		...
		if (_datasource_Root_CraftingOrders != null)
		{
			...
			for (int i = 0; i < _datasource_Root_CraftingOrders.Count; i++)
			{
				...
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_28_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_1_0_4_2_0_0.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_28_ItemTemplate, i);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_28_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_28_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_28_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_28_ItemTemplate.SetDataSource(dataSource);
