...
public class CharacterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_3_Standard_DropdownWithHorizontalControl__DependendPrefab : ListPanel
{
		...
		if (_datasource_Root_SelectionSelector != null)
		{
			...
			if (_datasource_Root_SelectionSelector_ItemList != null)
			{
				...
				for (int num = _widget_1_1_0_0_0_0.ChildCount - 1; num >= 0; num--)
				{
					...
					((CharacterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate)_widget_1_1_0_0_0_0.GetChild(num)).DestroyDataSource();
				}
	...
	public void OnList_datasource_Root_SelectionSelector_ItemListChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_1_1_0_0_0_0.AddChildAtIndex(characterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate, e.NewIndex);
		...
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			...
			((CharacterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_1_1_0_0_0_0.GetChild(e.NewIndex);
			((CharacterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root_SelectionSelector(CampaignOptionSelectorVM newDataSource)
	{
		...
		if (_datasource_Root_SelectionSelector_ItemList != null)
		{
			...
			for (int i = 0; i < _datasource_Root_SelectionSelector_ItemList.Count; i++)
			{
				...
				characterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_1_1_0_0_0_0.AddChildAtIndex(characterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate, i);
				characterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate.CreateWidgets();
				characterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate.SetIds();
				characterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate.SetAttributes();
				characterCreationOptionsStage__TaleWorlds_CampaignSystem_ViewModelCollection_CharacterCreation_OptionsStage_CharacterCreationOptionsStageVM_Dependency_4_ItemTemplate.SetDataSource(dataSource);
