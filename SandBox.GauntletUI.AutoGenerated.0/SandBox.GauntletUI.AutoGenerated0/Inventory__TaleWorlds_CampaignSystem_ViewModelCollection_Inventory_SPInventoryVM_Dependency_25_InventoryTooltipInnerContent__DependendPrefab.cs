...
public class Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_25_InventoryTooltipInnerContent__DependendPrefab : ListPanel
{
	...
	public void DestroyDataSource()
	{
		...
		{
			_datasource_Root_ComparedItemFlagList.ListChanged -= OnList_datasource_Root_ComparedItemFlagListChanged;
			for (int num = _widget_1.ChildCount - 1; num >= 0; num--)
			{
				...
				((Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate)_widget_1.GetChild(num)).DestroyDataSource();
			}
		...
		if (_datasource_Root_AlternativeUsages != null)
		{
			...
			for (int num2 = _widget_2_0.ChildCount - 1; num2 >= 0; num2--)
			{
				...
				((Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate)_widget_2_0.GetChild(num2)).DestroyDataSource();
			}
			_datasource_Root_AlternativeUsages = null;
		}
		if (_datasource_Root_ComparedItemProperties != null)
		{
			_datasource_Root_ComparedItemProperties.ListChanged -= OnList_datasource_Root_ComparedItemPropertiesChanged;
			for (int num3 = _widget_3_0.ChildCount - 1; num3 >= 0; num3--)
			{
				...
				((Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate)_widget_3_0.GetChild(num3)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_ComparedItemFlagListChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		{
			for (int i = 0; i < _datasource_Root_ComparedItemFlagList.Count; i++)
			{
				ItemFlagVM bindingObject = _datasource_Root_ComparedItemFlagList[i];
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			ItemFlagVM dataSource = (ItemFlagVM)(generatedWidgetData.Data = _datasource_Root_ComparedItemFlagList[e.NewIndex]);
			...
			_widget_1.AddChildAtIndex(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate, e.NewIndex);
	...
	public void OnList_datasource_Root_AlternativeUsagesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_2_0.AddChildAtIndex(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate, e.NewIndex);
		...
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			...
			((Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate)child).SetDataSource(null);
	...
	public void OnList_datasource_Root_ComparedItemPropertiesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		switch (e.ListChangedType)
		{
		case TaleWorlds.Library.ListChangedType.Reset:
		...
		case TaleWorlds.Library.ListChangedType.Sorted:
		{
			for (int i = 0; i < _datasource_Root_ComparedItemProperties.Count; i++)
			{
				ItemMenuTooltipPropertyVM bindingObject = _datasource_Root_ComparedItemProperties[i];
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			ItemMenuTooltipPropertyVM dataSource = (ItemMenuTooltipPropertyVM)(generatedWidgetData.Data = _datasource_Root_ComparedItemProperties[e.NewIndex]);
			...
			_widget_3_0.AddChildAtIndex(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate, e.NewIndex);
		...
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			...
			((Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(ItemMenuVM newDataSource)
	{
		...
		if (_datasource_Root_ComparedItemFlagList != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ComparedItemFlagList.Count; i++)
			{
				Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate = new Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate(base.Context);
				GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate);
				ItemFlagVM dataSource = (ItemFlagVM)(generatedWidgetData.Data = _datasource_Root_ComparedItemFlagList[i]);
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_1.AddChildAtIndex(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate, i);
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate.CreateWidgets();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate.SetIds();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate.SetAttributes();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_31_ItemTemplate.SetDataSource(dataSource);
		...
		if (_datasource_Root_AlternativeUsages != null)
		{
			...
			for (int j = 0; j < _datasource_Root_AlternativeUsages.Count; j++)
			{
				...
				_widget_2_0.AddChildAtIndex(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate, j);
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate.CreateWidgets();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate.SetIds();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate.SetAttributes();
		...
		{
			_datasource_Root_ComparedItemProperties.ListChanged += OnList_datasource_Root_ComparedItemPropertiesChanged;
			for (int k = 0; k < _datasource_Root_ComparedItemProperties.Count; k++)
			{
				Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate = new Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate(base.Context);
				...
				ItemMenuTooltipPropertyVM dataSource3 = (ItemMenuTooltipPropertyVM)(generatedWidgetData3.Data = _datasource_Root_ComparedItemProperties[k]);
				...
				_widget_3_0.AddChildAtIndex(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate, k);
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate.CreateWidgets();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate.SetIds();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate.SetAttributes();
	...
	private void RefreshDataSource_datasource_Root_AlternativeUsages(MBBindingList<StringItemWithHintVM> newDataSource)
	{
		...
		if (_datasource_Root_AlternativeUsages != null)
		{
			...
			for (int i = 0; i < _datasource_Root_AlternativeUsages.Count; i++)
			{
				...
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_2_0.AddChildAtIndex(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate, i);
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate.CreateWidgets();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate.SetIds();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate.SetAttributes();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_32_ItemTemplate.SetDataSource(dataSource);
	...
	private void RefreshDataSource_datasource_Root_ComparedItemProperties(MBBindingList<ItemMenuTooltipPropertyVM> newDataSource)
	{
		...
		if (_datasource_Root_ComparedItemProperties != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ComparedItemProperties.Count; i++)
			{
				Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate = new Inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate(base.Context);
				GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate);
				ItemMenuTooltipPropertyVM dataSource = (ItemMenuTooltipPropertyVM)(generatedWidgetData.Data = _datasource_Root_ComparedItemProperties[i]);
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_3_0.AddChildAtIndex(inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate, i);
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate.CreateWidgets();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate.SetIds();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate.SetAttributes();
				inventory__TaleWorlds_CampaignSystem_ViewModelCollection_Inventory_SPInventoryVM_Dependency_33_ItemTemplate.SetDataSource(dataSource);
