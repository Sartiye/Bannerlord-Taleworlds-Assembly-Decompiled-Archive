...
public class SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_7_SPScoreboardSide__DependendPrefab : Widget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_Parties != null)
		{
			...
			for (int num = _widget_0_0_0.ChildCount - 1; num >= 0; num--)
			{
				...
				((SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate)_widget_0_0_0.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_PartiesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_0_0.AddChildAtIndex(sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate, e.NewIndex);
		...
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			...
			((SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_0_0_0.GetChild(e.NewIndex);
			((SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(SPScoreboardSideVM newDataSource)
	{
		...
		if (_datasource_Root_Parties != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Parties.Count; i++)
			{
				...
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_0_0.AddChildAtIndex(sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate, i);
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate.CreateWidgets();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate.SetIds();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate.SetAttributes();
				sPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_13_ItemTemplate.SetDataSource(dataSource);
