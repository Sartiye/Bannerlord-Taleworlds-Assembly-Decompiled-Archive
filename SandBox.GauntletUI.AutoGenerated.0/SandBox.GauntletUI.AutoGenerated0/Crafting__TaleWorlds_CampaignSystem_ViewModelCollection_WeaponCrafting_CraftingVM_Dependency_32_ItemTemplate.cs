...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_32_ItemTemplate : Widget
{
	...
	public void CreateWidgets()
	{
		...
		_widget_0_0 = new CraftingPieceItemButtonWidget(base.Context);
		...
		_widget_0_0_4 = new ListPanel(base.Context);
		_widget_0_0.AddChild(_widget_0_0_4);
		_widget_0_0_5 = new CraftingCardHighlightBrushWidget(base.Context);
		_widget_0_0.AddChild(_widget_0_0_5);
		_widget_0_0_5_0 = new CraftingCardHighlightBrushWidget(base.Context);
		_widget_0_0_5.AddChild(_widget_0_0_5_0);
	...
	public void SetIds()
	{
		_widget_0_0_0.Id = "ImageIdentifier";
	}
	...
	public void SetAttributes()
	{
		...
		_widget_0_0.DontHavePieceBrush = base.Context.GetBrush("Crafting.Piece.Card.DontHavePiece");
		_widget_0_0.HasPieceBrush = base.Context.GetBrush("Crafting.Piece.Card.HavePiece");
		_widget_0_0.UpdateChildrenStates = true;
		_widget_0_0.ImageIdentifier = _widget_0_0_0;
		_widget_0_0.DontHavePieceMaterialBrush = base.Context.GetBrush("Crafting.Piece.MaterialBrush.DontHavePiece");
		_widget_0_0.HasPieceMaterialBrush = base.Context.GetBrush("Crafting.Piece.MaterialBrush.HavePiece");
		_widget_0_0_0.WidthSizePolicy = SizePolicy.Fixed;
		_widget_0_0_0.HeightSizePolicy = SizePolicy.Fixed;
		_widget_0_0_0.SuggestedWidth = 98f;
		_widget_0_0_0.SuggestedHeight = 76f;
		...
		_widget_0_0_2.MarginLeft = 23f;
		_widget_0_0_2.MarginBottom = 24f;
		_widget_0_0_2.Brush = base.Context.GetBrush("Crafting.Piece.Lock.Icon");
		_widget_0_0_3.WidthSizePolicy = SizePolicy.CoverChildren;
		_widget_0_0_3.HeightSizePolicy = SizePolicy.CoverChildren;
		_widget_0_0_3.MarginTop = 23f;
		_widget_0_0_3.MarginLeft = 25f;
		_widget_0_0_3.Brush = base.Context.GetBrush("Crafting.Card.Tier.Text");
		_widget_0_0_4.WidthSizePolicy = SizePolicy.CoverChildren;
		_widget_0_0_4.HeightSizePolicy = SizePolicy.Fixed;
		_widget_0_0_4.SuggestedHeight = 25f;
		_widget_0_0_4.HorizontalAlignment = HorizontalAlignment.Right;
		_widget_0_0_4.VerticalAlignment = VerticalAlignment.Bottom;
		_widget_0_0_4.MarginRight = 22f;
		_widget_0_0_4.MarginBottom = 19f;
		_widget_0_0_4.StackLayout.LayoutMethod = LayoutMethod.HorizontalRightToLeft;
		_widget_0_0_5.WidthSizePolicy = SizePolicy.StretchToParent;
		_widget_0_0_5.HeightSizePolicy = SizePolicy.StretchToParent;
		_widget_0_0_5.UpdateChildrenStates = true;
		_widget_0_0_5.Brush = base.Context.GetBrush("Crafting.Piece.Card.NewlyUnlocked.Overlay");
		_widget_0_0_5.MarginTop = 18f;
		_widget_0_0_5.MarginBottom = 18f;
		_widget_0_0_5.MarginLeft = 18f;
		_widget_0_0_5.MarginRight = 18f;
		_widget_0_0_5_0.WidthSizePolicy = SizePolicy.Fixed;
		_widget_0_0_5_0.HeightSizePolicy = SizePolicy.Fixed;
		_widget_0_0_5_0.SuggestedWidth = 15f;
		_widget_0_0_5_0.SuggestedHeight = 15f;
		_widget_0_0_5_0.VerticalAlignment = VerticalAlignment.Top;
		_widget_0_0_5_0.HorizontalAlignment = HorizontalAlignment.Right;
		_widget_0_0_5_0.MarginTop = 5f;
		_widget_0_0_5_0.MarginRight = 5f;
		_widget_0_0_5_0.Brush = base.Context.GetBrush("Crafting.Piece.Card.NewlyUnlocked.Dot");
	...
	public void DestroyDataSource()
	{
		...
		{
			_datasource_Root_ItemAttributeIcons.ListChanged -= OnList_datasource_Root_ItemAttributeIconsChanged;
			for (int num = _widget_0_0_4.ChildCount - 1; num >= 0; num--)
			{
				Widget child = _widget_0_0_4.GetChild(num);
				...
				((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate)_widget_0_0_4.GetChild(num)).DestroyDataSource();
			}
	...
	private void HandleWidgetPropertyChangeOf_widget_0_0_1(string propertyName)
	{
		...
		{
			_datasource_Root.IsEmpty = _widget_0_0_1.IsVisible;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_0_0_2(string propertyName)
	{
		if (propertyName == "IsHidden")
		{
			_datasource_Root.PlayerHasPiece = _widget_0_0_2.IsHidden;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_0_0_5(string propertyName)
	{
		if (propertyName == "IsVisible")
		{
			_datasource_Root.IsNewlyUnlocked = _widget_0_0_5.IsVisible;
		}
	}
	...
	private void HandleWidgetPropertyChangeOf_widget_0_0_0(string propertyName)
	{
		...
		{
		case "AdditionalArgs":
			_datasource_Root_ImageIdentifier.AdditionalArgs = _widget_0_0_0.AdditionalArgs;
			break;
		case "ImageId":
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		...
		case "PlayerHasPiece":
			...
			_widget_0_0_2.IsHidden = _datasource_Root.PlayerHasPiece;
			break;
		case "IsEmpty":
			_widget_0_0_1.IsVisible = _datasource_Root.IsEmpty;
			break;
		case "TierText":
			_widget_0_0_3.Text = _datasource_Root.TierText;
			break;
		case "IsNewlyUnlocked":
			_widget_0_0_5.IsVisible = _datasource_Root.IsNewlyUnlocked;
			break;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root_ImageIdentifier(string propertyName)
	{
		...
		{
		case "AdditionalArgs":
			_widget_0_0_0.AdditionalArgs = _datasource_Root_ImageIdentifier.AdditionalArgs;
			break;
		case "Id":
	...
	public void OnList_datasource_Root_ItemAttributeIconsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.Reset:
		{
			for (int num = _widget_0_0_4.ChildCount - 1; num >= 0; num--)
			{
				Widget child3 = _widget_0_0_4.GetChild(num);
				...
				Widget child4 = _widget_0_0_4.GetChild(num);
				...
				_widget_0_0_4.RemoveChild(child4);
			}
			break;
		}
		case TaleWorlds.Library.ListChangedType.Sorted:
		{
			for (int i = 0; i < _datasource_Root_ItemAttributeIcons.Count; i++)
			{
				CraftingItemFlagVM bindingObject = _datasource_Root_ItemAttributeIcons[i];
				_widget_0_0_4.FindChild((Widget widget) => widget.GetComponent<GeneratedWidgetData>().Data == bindingObject).SetSiblingIndex(i);
			}
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			CraftingItemFlagVM dataSource = (CraftingItemFlagVM)(generatedWidgetData.Data = _datasource_Root_ItemAttributeIcons[e.NewIndex]);
			...
			_widget_0_0_4.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate, e.NewIndex);
		...
		{
			Widget child2 = _widget_0_0_4.GetChild(e.NewIndex);
		...
		{
			Widget child = _widget_0_0_4.GetChild(e.NewIndex);
			((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate)child).SetDataSource(null);
			_widget_0_0_4.RemoveChild(child);
			break;
		}
	...
	private void RefreshDataSource_datasource_Root(CraftingPieceVM newDataSource)
	{
		if (_datasource_Root != null)
		{
			...
			if (_datasource_Root_ItemAttributeIcons != null)
			{
				...
				for (int num = _widget_0_0_4.ChildCount - 1; num >= 0; num--)
				{
					Widget child = _widget_0_0_4.GetChild(num);
					((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate)child).OnBeforeRemovedChild(child);
					Widget child2 = _widget_0_0_4.GetChild(num);
					...
					_widget_0_0_4.RemoveChild(child2);
				}
				_datasource_Root_ItemAttributeIcons = null;
			}
			_datasource_Root = null;
		...
		if (_datasource_Root_ItemAttributeIcons != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ItemAttributeIcons.Count; i++)
			{
				Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate = new Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate(base.Context);
				GeneratedWidgetData generatedWidgetData = new GeneratedWidgetData(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate);
				CraftingItemFlagVM dataSource = (CraftingItemFlagVM)(generatedWidgetData.Data = _datasource_Root_ItemAttributeIcons[i]);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_0_4.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate, i);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_41_ItemTemplate.SetDataSource(dataSource);
