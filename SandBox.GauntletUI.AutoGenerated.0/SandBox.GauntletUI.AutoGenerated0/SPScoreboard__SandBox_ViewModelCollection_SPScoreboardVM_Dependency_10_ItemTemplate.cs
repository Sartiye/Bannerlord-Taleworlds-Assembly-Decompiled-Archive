...
public class SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate : Widget
{
	...
	public SPScoreboard__SandBox_ViewModelCollection_SPScoreboardVM_Dependency_10_ItemTemplate(UIContext context)
		: base(context)
	{
	}
