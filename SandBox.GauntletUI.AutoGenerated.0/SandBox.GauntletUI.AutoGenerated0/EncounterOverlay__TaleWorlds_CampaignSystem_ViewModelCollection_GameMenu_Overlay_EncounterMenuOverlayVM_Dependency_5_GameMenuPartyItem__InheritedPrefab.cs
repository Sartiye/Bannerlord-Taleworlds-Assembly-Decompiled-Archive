...
public class EncounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_5_GameMenuPartyItem__InheritedPrefab : GameMenuPartyItemButtonWidget
{
	...
	public virtual void DestroyDataSource()
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int num = _widget_0_3.ChildCount - 1; num >= 0; num--)
			{
				...
				((EncounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate)_widget_0_3.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_QuestsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_3.AddChildAtIndex(encounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate, e.NewIndex);
			...
			encounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_0_3.GetChild(e.NewIndex);
			((EncounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_0_3.GetChild(e.NewIndex);
			((EncounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(GameMenuPartyItemVM newDataSource)
	{
		...
		if (_datasource_Root_Quests != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Quests.Count; i++)
			{
				...
				encounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_3.AddChildAtIndex(encounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate, i);
				encounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate.CreateWidgets();
				encounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate.SetIds();
				encounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate.SetAttributes();
				encounterOverlay__TaleWorlds_CampaignSystem_ViewModelCollection_GameMenu_Overlay_EncounterMenuOverlayVM_Dependency_7_ItemTemplate.SetDataSource(dataSource);
