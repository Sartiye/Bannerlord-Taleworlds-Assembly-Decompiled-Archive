...
internal static class ScriptingInterfaceObjects
{
	private enum CoreInterfaceGeneratedEnum
	{
		...
		enm_IMono_MBMission_get_tick_debug_paused = 511,
		enm_IMono_MBMission_get_time = 512,
		enm_IMono_MBMission_get_velocity_of_missile = 513,
		enm_IMono_MBMission_get_water_level_at_position = 514,
		enm_IMono_MBMission_get_weighted_point_of_enemies = 515,
		enm_IMono_MBMission_has_any_agents_of_team_around = 516,
		enm_IMono_MBMission_idle_tick = 517,
		enm_IMono_MBMission_initialize_mission = 518,
		enm_IMono_MBMission_is_agent_in_proximity_map = 519,
		enm_IMono_MBMission_is_formation_unit_position_available = 520,
		enm_IMono_MBMission_is_position_inside_any_blocker_nav_mesh_face_2d = 521,
		enm_IMono_MBMission_is_position_inside_boundaries = 522,
		enm_IMono_MBMission_is_position_inside_hard_boundaries = 523,
		enm_IMono_MBMission_is_position_on_any_blocker_nav_mesh_face = 524,
		enm_IMono_MBMission_make_sound = 525,
		enm_IMono_MBMission_make_sound_only_on_related_peer = 526,
		enm_IMono_MBMission_make_sound_with_parameter = 527,
		enm_IMono_MBMission_on_fast_forward_state_changed = 528,
		enm_IMono_MBMission_pause_mission_scene_sounds = 529,
		enm_IMono_MBMission_prepare_missile_weapon_for_drop = 530,
		enm_IMono_MBMission_process_record_until_time = 531,
		enm_IMono_MBMission_agent_proximity_map_begin_search = 532,
		enm_IMono_MBMission_agent_proximity_map_find_next = 533,
		enm_IMono_MBMission_agent_proximity_map_get_max_search_radius = 534,
		enm_IMono_MBMission_ray_cast_for_closest_agent = 535,
		enm_IMono_MBMission_ray_cast_for_closest_agents_limbs = 536,
		enm_IMono_MBMission_ray_cast_for_given_agents_limbs = 537,
		enm_IMono_MBMission_record_current_state = 538,
		enm_IMono_MBMission_remove_boundary = 539,
		enm_IMono_MBMission_remove_missile = 540,
		enm_IMono_MBMission_reset_first_third_person_view = 541,
		enm_IMono_MBMission_reset_teams = 542,
		enm_IMono_MBMission_restart_record = 543,
		enm_IMono_MBMission_restore_record_from_file = 544,
		enm_IMono_MBMission_resume_mission_scene_sounds = 545,
		enm_IMono_MBMission_set_bow_missile_speed_modifier = 546,
		enm_IMono_MBMission_set_camera_frame = 547,
		enm_IMono_MBMission_set_camera_is_first_person = 548,
		enm_IMono_MBMission_set_close_proximity_wave_sounds_enabled = 549,
		enm_IMono_MBMission_set_combat_type = 550,
		enm_IMono_MBMission_set_crossbow_missile_speed_modifier = 551,
		enm_IMono_MBMission_set_debug_agent = 552,
		enm_IMono_MBMission_set_fall_avoid_system_active = 553,
		enm_IMono_MBMission_set_last_movement_key_pressed = 554,
		enm_IMono_MBMission_set_missile_range_modifier = 555,
		enm_IMono_MBMission_set_mission_corpse_fade_out_time_in_seconds = 556,
		enm_IMono_MBMission_set_navigation_face_cost_with_id_around_position = 557,
		enm_IMono_MBMission_set_override_corpse_count = 558,
		enm_IMono_MBMission_set_pause_ai_tick = 559,
		enm_IMono_MBMission_set_random_decide_time_of_agents = 560,
		enm_IMono_MBMission_set_render_parallel_logic_in_progress = 561,
		enm_IMono_MBMission_set_report_stuck_agents_mode = 562,
		enm_IMono_MBMission_set_throwing_missile_speed_modifier = 563,
		enm_IMono_MBMission_set_velocity_of_missile = 564,
		enm_IMono_MBMission_skip_forward_mission_replay = 565,
		enm_IMono_MBMission_start_recording = 566,
		enm_IMono_MBMission_tick = 567,
		enm_IMono_MBMission_tick_agents_and_teams_async = 568,
		enm_IMono_MBNetwork_add_new_bot_on_server = 569,
		enm_IMono_MBNetwork_add_new_player_on_server = 570,
		enm_IMono_MBNetwork_add_peer_to_disconnect = 571,
		enm_IMono_MBNetwork_begin_broadcast_module_event = 572,
		enm_IMono_MBNetwork_begin_module_event_as_client = 573,
		enm_IMono_MBNetwork_can_add_new_players_on_server = 574,
		enm_IMono_MBNetwork_clear_replication_table_statistics = 575,
		enm_IMono_MBNetwork_elapsed_time_since_last_udp_packet_arrived = 576,
		enm_IMono_MBNetwork_end_broadcast_module_event = 577,
		enm_IMono_MBNetwork_end_module_event_as_client = 578,
		enm_IMono_MBNetwork_get_active_udp_sessions_ip_address = 579,
		enm_IMono_MBNetwork_get_average_packet_loss_ratio = 580,
		enm_IMono_MBNetwork_get_debug_uploads_in_bits = 581,
		enm_IMono_MBNetwork_get_multiplayer_disabled = 582,
		enm_IMono_MBNetwork_initialize_client_side = 583,
		enm_IMono_MBNetwork_initialize_server_side = 584,
		enm_IMono_MBNetwork_is_dedicated_server = 585,
		enm_IMono_MBNetwork_prepare_new_udp_session = 586,
		enm_IMono_MBNetwork_print_debug_stats = 587,
		enm_IMono_MBNetwork_print_replication_table_statistics = 588,
		enm_IMono_MBNetwork_read_byte_array_from_packet = 589,
		enm_IMono_MBNetwork_read_float_from_packet = 590,
		enm_IMono_MBNetwork_read_int_from_packet = 591,
		enm_IMono_MBNetwork_read_long_from_packet = 592,
		enm_IMono_MBNetwork_read_string_from_packet = 593,
		enm_IMono_MBNetwork_read_uint_from_packet = 594,
		enm_IMono_MBNetwork_read_ulong_from_packet = 595,
		enm_IMono_MBNetwork_remove_bot_on_server = 596,
		enm_IMono_MBNetwork_reset_debug_uploads = 597,
		enm_IMono_MBNetwork_reset_debug_variables = 598,
		enm_IMono_MBNetwork_reset_mission_data = 599,
		enm_IMono_MBNetwork_server_ping = 600,
		enm_IMono_MBNetwork_set_server_bandwidth_limit_in_mbps = 601,
		enm_IMono_MBNetwork_set_server_frame_rate = 602,
		enm_IMono_MBNetwork_set_server_tick_rate = 603,
		enm_IMono_MBNetwork_terminate_client_side = 604,
		enm_IMono_MBNetwork_terminate_server_side = 605,
		enm_IMono_MBNetwork_write_byte_array_to_packet = 606,
		enm_IMono_MBNetwork_write_float_to_packet = 607,
		enm_IMono_MBNetwork_write_int_to_packet = 608,
		enm_IMono_MBNetwork_write_long_to_packet = 609,
		enm_IMono_MBNetwork_write_string_to_packet = 610,
		enm_IMono_MBNetwork_write_uint_to_packet = 611,
		enm_IMono_MBNetwork_write_ulong_to_packet = 612,
		enm_IMono_MBPeer_begin_module_event = 613,
		enm_IMono_MBPeer_end_module_event = 614,
		enm_IMono_MBPeer_get_average_loss_percent = 615,
		enm_IMono_MBPeer_get_average_ping_in_milliseconds = 616,
		enm_IMono_MBPeer_get_host = 617,
		enm_IMono_MBPeer_get_is_synchronized = 618,
		enm_IMono_MBPeer_get_port = 619,
		enm_IMono_MBPeer_get_reversed_host = 620,
		enm_IMono_MBPeer_is_active = 621,
		enm_IMono_MBPeer_send_existing_objects = 622,
		enm_IMono_MBPeer_set_controlled_agent = 623,
		enm_IMono_MBPeer_set_is_synchronized = 624,
		enm_IMono_MBPeer_set_relevant_game_options = 625,
		enm_IMono_MBPeer_set_team = 626,
		enm_IMono_MBPeer_set_user_data = 627,
		enm_IMono_MBScreen_on_edit_mode_enter_press = 628,
		enm_IMono_MBScreen_on_edit_mode_enter_release = 629,
		enm_IMono_MBScreen_on_exit_button_click = 630,
		enm_IMono_MBSkeletonExtensions_create_agent_skeleton = 631,
		enm_IMono_MBSkeletonExtensions_create_simple_skeleton = 632,
		enm_IMono_MBSkeletonExtensions_create_with_action_set = 633,
		enm_IMono_MBSkeletonExtensions_does_action_continue_with_current_action_at_channel = 634,
		enm_IMono_MBSkeletonExtensions_get_action_at_channel = 635,
		enm_IMono_MBSkeletonExtensions_get_bone_entitial_frame = 636,
		enm_IMono_MBSkeletonExtensions_get_bone_entitial_frame_at_animation_progress = 637,
		enm_IMono_MBSkeletonExtensions_get_skeleton_face_animation_name = 638,
		enm_IMono_MBSkeletonExtensions_get_skeleton_face_animation_time = 639,
		enm_IMono_MBSkeletonExtensions_set_agent_action_channel = 640,
		enm_IMono_MBSkeletonExtensions_set_animation_at_channel = 641,
		enm_IMono_MBSkeletonExtensions_set_facial_animation_of_channel = 642,
		enm_IMono_MBSkeletonExtensions_set_skeleton_face_animation_time = 643,
		enm_IMono_MBSkeletonExtensions_tick_action_channels = 644,
		enm_IMono_MBSoundEvent_create_event_from_external_file = 645,
		enm_IMono_MBSoundEvent_create_event_from_sound_buffer = 646,
		enm_IMono_MBSoundEvent_play_sound = 647,
		enm_IMono_MBSoundEvent_play_sound_with_int_param = 648,
		enm_IMono_MBSoundEvent_play_sound_with_param = 649,
		enm_IMono_MBSoundEvent_play_sound_with_str_param = 650,
		enm_IMono_MBTeam_is_enemy = 651,
		enm_IMono_MBTeam_set_is_enemy = 652,
		enm_IMono_MBTestRun_auto_continue = 653,
		enm_IMono_MBTestRun_close_scene = 654,
		enm_IMono_MBTestRun_enter_edit_mode = 655,
		enm_IMono_MBTestRun_get_fps = 656,
		enm_IMono_MBTestRun_leave_edit_mode = 657,
		enm_IMono_MBTestRun_new_scene = 658,
		enm_IMono_MBTestRun_open_default_scene = 659,
		enm_IMono_MBTestRun_open_scene = 660,
		enm_IMono_MBTestRun_save_scene = 661,
		enm_IMono_MBTestRun_start_mission = 662,
		enm_IMono_MBVoiceManager_get_voice_definition_count_with_monster_sound_and_collision_info_class_name = 663,
		enm_IMono_MBVoiceManager_get_voice_definitions_with_monster_sound_and_collision_info_class_name = 664,
		enm_IMono_MBVoiceManager_get_voice_type_index = 665,
		enm_IMono_MBWindowManager_dont_change_cursor_pos = 666,
		enm_IMono_MBWindowManager_erase_message_lines = 667,
		enm_IMono_MBWindowManager_get_screen_resolution = 668,
		enm_IMono_MBWindowManager_pre_display = 669,
		enm_IMono_MBWindowManager_screen_to_world = 670,
		enm_IMono_MBWindowManager_world_to_screen = 671,
		enm_IMono_MBWindowManager_world_to_screen_with_fixed_z = 672,
		enm_IMono_MBWorld_check_resource_modifications = 673,
		enm_IMono_MBWorld_fix_skeletons = 674,
		enm_IMono_MBWorld_get_game_type = 675,
		enm_IMono_MBWorld_get_global_time = 676,
		enm_IMono_MBWorld_get_last_messages = 677,
		enm_IMono_MBWorld_pause_game = 678,
		enm_IMono_MBWorld_set_body_used = 679,
		enm_IMono_MBWorld_set_game_type = 680,
		enm_IMono_MBWorld_set_material_used = 681,
		enm_IMono_MBWorld_set_mesh_used = 682,
		enm_IMono_MBWorld_unpause_game = 683
	}
