...
public class NavalCustomBattleScreen : ScreenBase, IGameStateListener
{
	...
	protected override void OnInitialize()
	{
		...
		_gauntletLayer = new GauntletLayer("NavalCustomBattle", 1, shouldClear: true);
	...
	protected override void OnFrameTick(float dt)
	{
		...
		if (_dataSource.FocusedShipItem != null && _gauntletLayer.Input.IsHotKeyReleased("SwitchToNextTab"))
		{
			UISoundsHelper.PlayUISound("event:/ui/default");
		...
		else if (_gauntletLayer.Input.IsHotKeyReleased("Confirm") && _dataSource.CanConfirm)
		{
			UISoundsHelper.PlayUISound("event:/ui/default");
	...
	private void LoadMovie()
	{
		if (!_isMovieLoaded)
		{
			_gauntletMovie = _gauntletLayer.LoadMovie("NavalCustomBattleScreen", _dataSource);
			_isMovieLoaded = true;
		}
	}
