...
public class SpriteData
{
	...
	private static SpriteDataLoadResult LoadFromDepot(ResourceDepot resourceDepot, string name)
	{
		...
		SpriteDataLoadResult spriteDataLoadResult = default(SpriteDataLoadResult);
		spriteDataLoadResult.SpriteCategories = new Dictionary<string, SpriteCategory>();
		spriteDataLoadResult.SpriteNames = new Dictionary<string, Sprite>();
		spriteDataLoadResult.SpritePartNames = new Dictionary<string, SpritePart>();
		SpriteDataLoadResult loadResult = spriteDataLoadResult;
