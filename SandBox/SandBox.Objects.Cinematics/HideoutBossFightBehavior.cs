...
public class HideoutBossFightBehavior : ScriptComponentBehavior
{
	...
	public void GetPlayerFrames(out MatrixFrame initialFrame, out MatrixFrame targetFrame, float perturbAmount = 0f)
	{
		...
		ComputeSpawnWorldFrame(System.MathF.PI, innerRadius, in localOffset, out initialFrame);
	...
	public void GetAlliesInitialFrame(out MatrixFrame frame)
	{
		...
		ComputeSpawnWorldFrame(System.MathF.PI, outerRadius, in localOffset, out frame);
	}
	...
	{
		Vec3 localPoint = base.GameEntity.GetGlobalFrame().TransformToLocal(in worldPoint);
	...
	private void UpdatePreview()
	{
		...
		frame2.rotation.ApplyScaleLocal(in scaleAmountXYZ);
