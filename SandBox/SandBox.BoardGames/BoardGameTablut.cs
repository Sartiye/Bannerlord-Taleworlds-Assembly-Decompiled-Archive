...
public class BoardGameTablut : BoardGameBase
{
	...
	public override void InitializeTiles()
	{
		...
		while (x2 < 9)
		{
			...
			for (y = 0; y < 9; y = num)
			{
				GameEntity gameEntity = source.Single((GameEntity e) => e.HasTag("tile_" + x2 + "_" + y));
				BoardGameDecal firstScriptOfType = source2.Single((GameEntity e) => e.HasTag("decal_" + x2 + "_" + y)).GetFirstScriptOfType<BoardGameDecal>();
				Tile2D tile = new Tile2D(gameEntity, firstScriptOfType, x2, y);
		...
		else if (!IsCitadelTile(King.X, King.Y))
		{
			...
			if (tile2.PawnOnTile == null && !flag7 && (flag6 || (tile.PawnOnTile != null && ((base.PlayerWhoStarted == PlayerTurn.PlayerOne && tile.PawnOnTile.PlayerOne) || (base.PlayerWhoStarted == PlayerTurn.PlayerTwo && !tile.PawnOnTile.PlayerOne)))))
			{
				...
				for (int num5 = num3; num5 >= num4; num5--)
				{
					...
					if (pawnOnTile != null)
					{
						if ((base.PlayerWhoStarted != 0 || !pawnOnTile.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile.PlayerOne))
						{
							break;
						}
				...
				if (!flag10)
				{
					...
					for (int num8 = num6; num8 >= num7; num8--)
					{
						...
						if (pawnOnTile2 != null)
						{
							if ((base.PlayerWhoStarted != 0 || !pawnOnTile2.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile2.PlayerOne))
							{
								break;
							}
				...
				if (!flag10)
				{
					...
					for (int k = num9; k < num9; k++)
					{
						...
						if (pawnOnTile3 != null)
						{
							if ((base.PlayerWhoStarted != 0 || !pawnOnTile3.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile3.PlayerOne))
							{
								break;
							}
			...
			if (!flag10 && tile.PawnOnTile == null && !flag6 && (flag7 || (tile2.PawnOnTile != null && ((base.PlayerWhoStarted == PlayerTurn.PlayerOne && tile2.PawnOnTile.PlayerOne) || (base.PlayerWhoStarted == PlayerTurn.PlayerTwo && !tile2.PawnOnTile.PlayerOne)))))
			{
				...
				for (int l = num10; l < num11; l++)
				{
					...
					if (pawnOnTile4 != null)
					{
						if ((base.PlayerWhoStarted != 0 || !pawnOnTile4.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile4.PlayerOne))
						{
							break;
						}
				...
				if (!flag10)
				{
					...
					for (int num14 = num12; num14 >= num13; num14--)
					{
						...
						if (pawnOnTile5 != null)
						{
							if ((base.PlayerWhoStarted != 0 || !pawnOnTile5.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile5.PlayerOne))
							{
								break;
							}
				...
				if (!flag10)
				{
					...
					for (int m = num15; m < num16; m++)
					{
						...
						if (pawnOnTile6 != null)
						{
							if ((base.PlayerWhoStarted != 0 || !pawnOnTile6.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile6.PlayerOne))
							{
								break;
							}
			...
			if (!flag10 && tile4.PawnOnTile == null && !flag9 && (flag8 || (tile3.PawnOnTile != null && ((base.PlayerWhoStarted == PlayerTurn.PlayerOne && tile3.PawnOnTile.PlayerOne) || (base.PlayerWhoStarted == PlayerTurn.PlayerTwo && !tile3.PawnOnTile.PlayerOne)))))
			{
				...
				for (int num19 = num17; num19 >= num18; num19--)
				{
					...
					if (pawnOnTile7 != null)
					{
						if ((base.PlayerWhoStarted != 0 || !pawnOnTile7.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile7.PlayerOne))
						{
							break;
						}
				...
				if (!flag10)
				{
					...
					for (int n = num20; n < num21; n++)
					{
						...
						if (pawnOnTile8 != null)
						{
							if ((base.PlayerWhoStarted != 0 || !pawnOnTile8.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile8.PlayerOne))
							{
								break;
							}
				...
				if (!flag10)
				{
					...
					for (int num24 = num22; num24 >= num23; num24--)
					{
						...
						if (pawnOnTile9 != null)
						{
							if ((base.PlayerWhoStarted != 0 || !pawnOnTile9.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile9.PlayerOne))
							{
								break;
							}
			...
			if (!flag10 && tile3.PawnOnTile == null && !flag8 && (flag9 || (tile4.PawnOnTile != null && ((base.PlayerWhoStarted == PlayerTurn.PlayerOne && tile4.PawnOnTile.PlayerOne) || (base.PlayerWhoStarted == PlayerTurn.PlayerTwo && !tile4.PawnOnTile.PlayerOne)))))
			{
				...
				for (int num27 = num25; num27 >= num26; num27--)
				{
					...
					{
						if ((base.PlayerWhoStarted != 0 || !pawnOnTile10.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile10.PlayerOne))
						{
							break;
						}
				...
				if (!flag10)
				{
					...
					for (int num30 = num28; num30 < num29; num30++)
					{
						...
						{
							if ((base.PlayerWhoStarted != 0 || !pawnOnTile11.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile11.PlayerOne))
							{
								break;
							}
				...
				if (!flag10)
				{
					...
					for (int num33 = num31; num33 < num32; num33++)
					{
						...
						{
							if ((base.PlayerWhoStarted != 0 || !pawnOnTile12.PlayerOne) && (base.PlayerWhoStarted != PlayerTurn.PlayerTwo || pawnOnTile12.PlayerOne))
							{
								break;
							}
