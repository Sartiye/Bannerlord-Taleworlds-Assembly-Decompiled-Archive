...
public class TownHorseRaceMissionController : MissionLogic, ITournamentGameBehavior
{
	...
	private void SetItemsAndSpawnCharacter(CharacterObject troop)
	{
		...
		AgentBuildData agentBuildData2 = agentBuildData.InitialDirection(in direction).Equipment(equipment).Controller((troop != CharacterObject.PlayerCharacter) ? AgentControllerType.AI : AgentControllerType.Player);
