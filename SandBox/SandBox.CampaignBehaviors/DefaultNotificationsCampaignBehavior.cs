...
public class DefaultNotificationsCampaignBehavior : CampaignBehaviorBase
{
	...
	{
		if (involvedParty.LeaderHero == null || involvedParty.LeaderHero.Clan != Clan.PlayerClan || involvedParty == PartyBase.MainParty || involvedParty.Side != 0 || involvedParty.MapEvent.AttackerSide.LeaderParty == null)
		{
			return;
		}
		bool flag = false;
