...
public class PrisonBreakMissionController : MissionLogic
{
	...
	private void SwitchToPhase2()
	{
		...
		foreach (Agent aliveGuardAgent in _aliveGuardAgents)
		{
			AlarmedBehaviorGroup behaviorGroup2 = aliveGuardAgent.GetComponent<CampaignAgentComponent>().AgentNavigator.GetBehaviorGroup<AlarmedBehaviorGroup>();
			WorldPosition suspiciousPosition = aliveGuardAgent.GetWorldPosition();
